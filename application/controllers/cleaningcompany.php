...
class Cleaningcompany extends CI_Controller{
	public function __construct(){
		parent:: __construct();
		$this->load->library('breadcrumbs');
		$this->ipaddress = $_SERVER['REMOTE_ADDR'];
		$this->load->model('cleaningcompany_model','cleaningcompany');
	...
	public function search(){
       ...
       public function searchbylocation(){
            if($_GET){
                ...
                $users   = $this->cleaningcompany->getAllcleaningcompany($latitude,$longitude,$per_page,$offset);
                if($users != false)
        ...
        public function getPages(){
            ...
            if($this->input->is_ajax_request()){
                ...
                $total_rows = $this->cleaningcompany->count($lat,$lon);
        ...
        function pages(){
            ...
            $data = array(
               'main_content' => 'frontend/cleaninghousehold/index',
