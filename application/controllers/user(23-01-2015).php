      ...
      public function new_profile(){
            if(!empty($_GET['value'])){
                ...
                $data['record'] = array(
                    ...
                    'organization_care' => $_GET['organization_care'],
                    );
                if($account_category == 1 ){
                    if($submit_id == 1){
                     ...
                     if($submit_id == 17){
                        ...
                        if($profile_check){
                           $this->load->view('frontend/care/seeker/babysitter_form',$data);
                            ...
                            echo "You have already own this job";
                        }                        
                    }
    ...
    public function addprofileconfirm(){
      ...
      public function pay(){
		...
		$data = array(
			...
			'package_amount'=> $res[0]['package_price'],
			'user_id'		=> $_POST['user_id'],
        ...
        $this->session->set_userdata('profile_id',$_POST['profile_id'] );
      ...
      public function pay_result(){
        echo "ok"; $user_id      = $this->uri->segment(3);
        $care_type    = $this->uri->segment(4);
      }
            ...
            if(isset($_POST['save'])){		
                 ...
                 if(isset($_POST['contact_number'])){
                    ...
                    $insert1 = array(
                        ...
                        'neighbour' => isset($_POST['neighbourhood'])?$_POST['neighbourhood']:'',
                    );
                       ...
                       $geodata = array(
                        ...
                        // $q = $this->common_model->update('tbl_user',$insert1,array('id'=>$this->session->userdata('current_user')));
                        //     if($q){
                        //         $this->common_model->update('tbl_userprofile',$insert2,array('user_id'=>$this->session->userdata('current_user')));        
                        //         
                        //     }
