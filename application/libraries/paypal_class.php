...
class paypal_class {
	...
	public function submit_paypal_post() {
		...
		echo "<div style='color:black; clear:both; margin-top:30px; text-align:center;'><h2>Please wait, your order is being processed and you";
		...
		echo "<input type=\"submit\" value=\"Click Here\"></div>\n";
