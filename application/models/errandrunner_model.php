	...
	class Errandrunner_model extends CI_Model{
		...
		public function search($search,$latitude,$longitude){
            ...
            if(is_array($search)){
				...
				if($smoker!=''){
					$sql .=" and tbl_userprofile.smoker=$smoker";
				}
                if($start_date!='')
		...
		public function countErrandRunner($lat,$lon){
