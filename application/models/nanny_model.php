...
class Nanny_model extends CI_model{
        ...
        public function searchbylocation($latitude,$longitude,$limit,$offset){
            ...
            if($postdata['bath_children'])
				$sql .= " and tbl_userprofile.bath_children=".$postdata['bath_children'];
            if($postdata['bed_children'])
				$sql .= " and tbl_userprofile.bed_children=".$postdata['bed_children'];
