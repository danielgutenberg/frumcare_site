    ...
    public function sort($per_page,$latitude,$longitude,$option,$account_category,$care_type,$distance){                                        
        ...
        if($care_type !=''){
            if($care_type == 28) {
                ...
                $sql.=" and tbl_userprofile.care_type = '8' ";
            }                
            elseif($care_type == 27) {
                $sql.= " and (FIND_IN_SET('Caregiving institution',tbl_userprofile.looking_to_work) or FIND_IN_SET('Caregiving Institution',tbl_userprofile.looking_to_work))";
                $sql.=" and tbl_userprofile.care_type = '6' ";    
            }
            elseif($care_type == 26) {
                $sql.= " and (FIND_IN_SET('Caregiving institution',tbl_userprofile.looking_to_work) or FIND_IN_SET('Caregiving Institution',tbl_userprofile.looking_to_work))";
                $sql.=" and tbl_userprofile.care_type = '5' ";    
            }
            elseif($care_type == 25) {
                $sql.= " and (FIND_IN_SET('Caregiving institution',tbl_userprofile.looking_to_work) or FIND_IN_SET('Caregiving Institution',tbl_userprofile.looking_to_work))";
                $sql.=" and tbl_userprofile.care_type = '1' ";    
            }
            else {
                die("404 Error Occured");
            }                            
        }
        
        else{
            $sql.=" and (tbl_userprofile.care_type = 1 or tbl_userprofile.care_type = 5 or tbl_userprofile.care_type = 6 or tbl_userprofile.care_type = 8)";
            $sql .= " and (FIND_IN_SET('Caregiving institution',tbl_userprofile.looking_to_work) or FIND_IN_SET('Caregiving Institution',tbl_userprofile.looking_to_work) or FIND_IN_SET('Cleaning Company',tbl_userprofile.looking_to_work))";                               
        }
