...
<div class="form-group">
	...
	<div class="ad-manager-checkbox">
		<input type="checkbox" value="Boys" name="looking_to_work[]" <?php if(in_array('Boys',$looking_to_work)){?> checked="checked" <?php } ?>> Boys
		<input type="checkbox" value="Girls" name="looking_to_work[]" <?php if(in_array('Girls',$looking_to_work)){?> checked="checked" <?php } ?>> Girls
	</div>
</div>
<div class="form-group">
