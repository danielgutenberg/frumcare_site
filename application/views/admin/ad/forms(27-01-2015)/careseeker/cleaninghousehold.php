...
<div class="form-group">
	...
	<div class="ad-manager-checkbox">
		<input type="checkbox" value="Floors" name="willing_to_work[]" <?php if(in_array('Floors',$willing_to_work)){?> checked="checked" <?php }?> > Floors<br/>
	    <input type="checkbox" value="Windows" name="willing_to_work[]" <?php if(in_array('Windows',$willing_to_work)){?> checked="checked" <?php }?> > Windows<br/>
	    <input type="checkbox" value="Dishes" name="willing_to_work[]" <?php if(in_array('Dishes',$willing_to_work)){?> checked="checked" <?php }?> > Dishes<br/>
	    <input type="checkbox" value="Laundry" name="willing_to_work[]" <?php if(in_array('Laundry',$willing_to_work)){?> checked="checked" <?php }?> > Laundry<br/>
	    <input type="checkbox" value="Wash" name="willing_to_work[]" <?php if(in_array('Wash',$willing_to_work)){?> checked="checked" <?php }?> > Wash<br/>
	    <input type="checkbox" value="Fold" name="willing_to_work[]" <?php if(in_array('Fold',$willing_to_work)){?> checked="checked" <?php }?> > Fold<br/>
	    <input type="checkbox" value="Iron" name="willing_to_work[]" <?php if(in_array('Iron',$willing_to_work)){?> checked="checked" <?php }?> > Iron<br/>
...
<div class="form-group">
	...
	<div class="ad-manager-checkbox"><br/>
