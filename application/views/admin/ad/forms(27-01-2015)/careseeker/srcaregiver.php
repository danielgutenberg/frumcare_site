...
<div class="form-group">
	...
	<div class="ad-manager-checkbox">
		<input type="radio" value="1" name="gender_of_caregiver" <?php if($detail[0]['gender_of_caregiver'] = 1){?> checked="checkde" <?php }?>> Male
        <input type="radio" value="2" name="gender_of_caregiver" <?php if($detail[0]['gender_of_caregiver'] = 2){?> checked="checkde" <?php }?>> Female
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="ad-manager-checkbox">
		<input type="checkbox" value="1" name="driver_license" <?php if($detail[0]['driver_license'] = 1){?>checked<?php }?> > Has Drivers license
		<input type="checkbox" value="1" name="vehicle" <?php if($detail[0]['vehicle'] = 1){?> checked <?php }?> >Has own Vehicle
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="ad-manager-checkbox">
		<input type="checkbox" value="CPR" name="training[]" <?php if($detail[0]['training']){?> checked="checked" <?php }?> > CPR<br/>
        <input type="checkbox" value="First Aid" name="training[]" <?php if($detail[0]['training']){?> checked="checked" <?php }?> > First Aid<br/>
        <input type="checkbox" value="Nanny/ Babysitter course" name="training[]" <?php if($detail[0]['training']){?> checked="checked" <?php }?> > Nanny/ Babysitter course<br/>
        <input type="checkbox" value="Not necessary" name="training[]" <?php if($detail[0]['training']){?> checked="checked" <?php }?> > Not necessary
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="ad-manager-checkbox">
		...
		<input type="checkbox" value="1" name="personal_hygiene" <?php if($detail[0]['personal_hygiene'] = 1){?> checked="checked" <?php }?>>Must be willing to deal with personal hygiene of senior
