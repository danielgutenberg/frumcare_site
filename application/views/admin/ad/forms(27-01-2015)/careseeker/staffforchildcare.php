...
<div class="form-group">
	...
	<div class="ad-manager-full-input">
		<select name="organization_type" class="required">
            ...
            <option value="Nursing home" <?php if($detail[0]['organization_type']){?> selected="selected" <?php }?> >Nursing home</option>
            <option value="Preschool" <?php if($detail[0]['organization_type']){?> selected="selected" <?php }?> >Preschool</option>
        </select> 
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="ad-manager-full-input">
		<select name="job_postion" class="required">
            ...
            <option value="Babysitter" <?php if($detail[0]['job_position'] == 'Babysitter'){?> selected="selected" <?php }?>  >Babysitter</option>
            <option value="Nanny"  <?php if($detail[0]['job_position'] == 'Nanny'){?> selected="selected" <?php }?> >Nanny</option>
            <option value="Tutor"  <?php if($detail[0]['job_position'] == 'Tutor'){?> selected="selected" <?php }?> >Tutor</option>
        </select> 
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="ad-manager-checkbox">
		<input type="checkbox" value="Occ./ reg./ one time" name="availability[]" <?php if(in_array('Occ./ reg./ one time',$availability)){?> checked="checked" <?php }?> > Occ./ reg./ one time<br/s>
        <input type="checkbox" value="Part Time" name="availability[]" <?php if(in_array('Part Time',$availability)){?> checked="checked" <?php }?> > Part Time<br/s>
        <input type="checkbox" value="Full Time" name="availability[]" <?php if(in_array('Full Time',$availability)){?> checked="checked" <?php }?> > Full Time<br/s>
        <input type="checkbox" value="Days/ hours" name="availability[]" <?php if(in_array('Days/ hours',$availability)){?> checked="checked" <?php }?> > Days/ hours<br/s>
        <input type="checkbox" value="Asap" name="availability[]" <?php if(in_array('Asap',$availability)){?> checked="checked" <?php }?> > Asap <br/s>
        <input type="checkbox" value="Start Date" name="availability[]" <?php if(in_array('Start date',$availability)){?> checked="checked" <?php }?> id="ckbox1"> Start Date
        <input type="text" name="start_date" value="<?php echo $start_date;?>" id="textbox1">
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="ad-manager-checkbox">
        ...
        <input type="checkbox" name="language[]" value="Sign language">Sign language
	</div>
</div>
<div class="form-group">
	<label class="control-label">Must have following training/ certification</label>
	<div class="ad-manager-checkbox">
		<input type="checkbox" value="CPR" name="training[]"> CPR<br/>
        <input type="checkbox" value="First Aid" name="training[]"> First Aid<br/>
        <input type="checkbox" value="Nanny/ Babysitter course" name="training[]"> Nanny/ Babysitter course<br/>
