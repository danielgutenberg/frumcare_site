...
<div class="form-group">
	...
	<div class="ad-manager-full-input">
        <div><input type="text" value="<?php echo $detail[0]['number_of_children'];?>" name="number_of_children" class="required number"></div>
...
<div class="form-group">
	...
	<div class="ad-manager-checkbox">
		<input type="checkbox" value="1" name="driver_license" <?php if($detail[0]['driver_license'] == 1){?> checked="checked" <?php } ?> >I have a drivers license<br/>
		...
		<input type="checkbox" value="1" name="bed_children" <?php if($detail[0]['bed_children'] == 1){?> checked="checked" <?php } ?>>Able to put children to bed<br />
