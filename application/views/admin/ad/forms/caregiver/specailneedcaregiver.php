...
<div class="form-group">
	...
	<div class="ad-manager-checkbox">
		...
		<input type="checkbox" value="Special Needs Training" name="training[]" <?php if(in_array('Special Needs Training',$temptraining)){?> checked="checked" <?php }?> />Special Needs Training<br />>
		<input type="checkbox" value="Nurse" name="training[]"  <?php if(in_array('Nurse',$temptraining)){?> checked="checked" <?php }?>>Nurse
...
<div class="form-group">
	...
	<div class="ad-manager-checkbox">
		...
		<div class="checkbox"><input type="checkbox" value="Weekends Fri./Sun." name="availability[]" <?php if(in_array("Weekends Fri./Sun.",$time)){?> checked="checked"<?php }?>> <span>Weekends Fri./Sun. Shabbos</span></div>
...
<div class="form-group">
	...
	<div class="ad-manager-checkbox">
		...
		<div class="checkbox" ><input type="checkbox" value="1" name="on_short_notice" <?php if($detail[0]['on_short_notice'] == 1){?> checked="checked" <?php }?> >Available on short notice</div>
	</div>
</div>
<script>
