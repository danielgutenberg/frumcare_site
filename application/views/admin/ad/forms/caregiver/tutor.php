...
<div class="form-group">
	...
	<div class="ad-manager-checkbox">
            ...
            <input type="checkbox" value="general studies" name="subjects[]" <?php if(in_array('general studies',$subjects)){?> checked="checked" <?php } ?>>General studies<br/>
            <input type="checkbox" value="limudei kodesh" name="subjects[]" <?php if(in_array('limudei kodesh',$subjects)){?> checked="checked" <?php } ?>>Limudei Kodesh<br/>
...
<div class="form-group">
	<label class="control-label">Abilities (check if yes)</label>
</tr>
<div class="form-group">
