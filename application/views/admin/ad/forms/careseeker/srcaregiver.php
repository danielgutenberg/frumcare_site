...
<div class="form-group"><div class="ad-manager-full-input">Additional Requirements</div></div> 
<div class="form-group">
...
<div class="form-group">
	...
	<div class="ad-manager-checkbox">
        ...
        <div class="checkbox" ><input type="checkbox" value="Senior Care Training" name="training[]" <?php if($detail[0]['training']){?> checked="checked" <?php }?> > Senior Care Training</div>
        <div class="checkbox" ><input type="checkbox" value="Nurse" name="training[]" <?php if($detail[0]['training']){?> checked="checked" <?php }?> > Nurse</div>
...
<div class="form-group">
	...
	<div class="ad-manager-checkbox">
        ...
        <div class="checkbox" ><input type="checkbox" value="1" name="cook" <?php if($detail[0]['cook'] = 1){?> checked="checked" <?php }?> >Must be able to cook and prepare food/ serve meals</div>
		<div class="checkbox" ><input type="checkbox" value="1" name="basic_housework" <?php if($detail[0]['basic_housework'] = 1){?> checked="checked" <?php }?>>Must be able to do light housework/ cleaning</div>
		<div class="checkbox" ><input type="checkbox" value="1" name="personal_hygiene" <?php if($detail[0]['personal_hygiene'] = 1){?> checked="checked" <?php }?>>Must be able to deal with personal hygiene of senior</div>
	</div>
</div>
<style type="text/css">
		html{
