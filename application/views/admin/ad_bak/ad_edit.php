                    ...
                    <form role="form" id="ad_add_edit_form" method="post" action="<?php echo base_url('admin/ad/edit/'.segment(4))?>" enctype="multipart/form-data">
                            <div class="form-group">
                                                    ...
                                                    <div class="ad-manager-input">
                                                       <?php echo $detail[0]['first_name'].' '.$detail[0]['last_name'] ;?>
                                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="ad-manager-input">
                                    ...
                                    ?>
                                    <?php 
                                        if($detail[0]['account_category'] == 2){ 
                                                echo "Careseeker";
                                        }
                                    ?>
                                </div>
                                <input type="hidden" name="account_category" value="<?php echo $detail[0]['account_category'];?>" />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="ad-manager-radio">
                                    <div><input type="radio" name="status" value="1" <?php if($detail[0]['status'] == 1){?> checked="checked" <?php  } ?> />  Active </div>
                                    <div><input type="radio" name="status" value="0" <?php if($detail[0]['status'] == 0){?> checked="checked" <?php  } ?>/>  Inactive </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Actions</label>
                                <div class="ad-manager-btns">
                                    <?php echo prev_next('admin/ad/edit',$detail[0]['id'],'tbl_user');?>
                                    ...
                                    <?php /* <a href="<?php echo site_url();?>admin" class="btn btn-default  btn-primary">Refresh</a> */?>
