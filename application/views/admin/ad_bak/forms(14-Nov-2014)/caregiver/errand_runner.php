...
<div class="form-group">
	...
	<div class="ad-manager-full-input">
		<input type="checkbox" value="Imm/ Start Date" <?php if(in_array('Imm/ Start Date', $temp)){?> checked="checked" <?php } ?> name="availability[]" />Imm/ Start Date
		<input type="checkbox" value="Part Time" <?php if(in_array('Part Time', $temp)){?> checked="checked" <?php } ?> name="availability[]" />Part Time
		<input type="checkbox" value="Full Time" <?php if(in_array('Full Time', $temp)){?> checked="checked" <?php } ?> name="availability[]" />Full Time
		<input type="checkbox" value="Morning" <?php if(in_array('Morning', $temp)){?> checked="checked" <?php } ?> name="availability[]" />Morning
		<input type="checkbox" value="Afternoon" <?php if(in_array('Afternoon', $temp)){?> checked="checked" <?php } ?> name="availability[]" />Afternoon
