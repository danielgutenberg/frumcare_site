...
<div class="form-group">
	...
	<div class="ad-manager-full-input">
		...
		<input type="checkbox" value="1" name="pick_up_child" <?php if($detail[0]['pick_up_child'] == 1){?> checked="checked" <?php } ?>>Willing to pick up kids from school
		<input type="checkbox" value="1" name="cook" <?php if($detail[0]['cook'] == 1){?> checked="checked" <?php } ?>>Willing to cook
		<input type="checkbox" value="1" name="basic_housework" <?php if($detail[0]['basic_housework'] == 1){?> checked="checked" <?php } ?> >Willing to do light housework/ cleaning
		<input type="checkbox" value="1" name="homework_help" <?php if($detail[0]['homework_help'] == 1){?> checked="checked" <?php } ?>>Willing to help with homework
		<input type="checkbox" value="1" name="sick_child_care" <?php if($detail[0]['sick_child_care'] == 1){?> checked="checked" <?php } ?> >Willing to care for sick child
		...
		<input type="checkbox" value="1" name="wash"  <?php if($detail[0]['wash'] == 1){?> checked="checked" <?php } ?>>Willing to wash
		<input type="checkbox" value="1" name="iron" <?php if($detail[0]['iron'] == 1){?> checked="checked" <?php } ?> >Willing to iron
		<input type="checkbox" value="1" name="fold" <?php if($detail[0]['fold'] == 1){?> checked="checked" <?php } ?>>Willing to fold
		<input type="checkbox" value="1" name="bath_children" <?php if($detail[0]['bath_children'] == 1){?> checked="checked" <?php } ?>>Willing to bath children
