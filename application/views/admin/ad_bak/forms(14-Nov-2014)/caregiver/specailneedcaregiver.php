...
<div class="form-group">
	...
	<div class="ad-manager-full-input">
		...
		<input type="checkbox" value="Nanny/ Babysitter Course" name="training[]" <?php if(in_array('First Aid',$temptraining)){?> checked="checked" <?php }?>>Nanny/ Babysitter Course
...
<div class="form-group">
	...
	<div class="ad-manager-full-input">
		<input type="checkbox" value="Autism" name="willing_to_work[]" <?php if(in_array('Autism', $tempwillingtowork)){?> checked="checked" <?php }?> >Autism
		<input type="checkbox" value="Down Syndrome" name="willing_to_work[]" <?php if(in_array('Down Syndrome', $tempwillingtowork)){?> checked="checked" <?php }?>>Down Syndrome
...
<div class="form-group">
	...
	<div class="ad-manager-full-input">
		<input type="checkbox" value="Imm/ Start Date" name="availability[]" <?php if(in_array('Imm/ Start Date',$tempavailabletime)){?> checked="checked" <?php } ?> >Imm/ Start Date
		<input type="checkbox" value="Part Time" name="availability[]" <?php if(in_array('Part Time',$tempavailabletime)){?> checked="checked" <?php } ?>>Part Time
		<input type="checkbox" value="Full Time" name="availability[]" <?php if(in_array('Full Time',$tempavailabletime)){?> checked="checked" <?php } ?>>Full Time
		<input type="checkbox" value="Afternoon" name="availability[]" <?php if(in_array('Afternoon',$tempavailabletime)){?> checked="checked" <?php } ?>>Afternoon
		<input type="checkbox" value="Weekends/ Shabbos" name="availability[]" <?php if(in_array('Weekends/ Shabbos',$tempavailabletime)){?> checked="checked" <?php } ?>>Weekends/ Shabbos
