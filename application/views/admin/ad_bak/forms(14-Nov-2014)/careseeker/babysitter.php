...
<div class="form-group">
	...
	<div class="ad-manager-full-input">
		<input type="checkbox" value="Occ./ reg./ one time" name="availability[]" <?php if(in_array("Occ./ reg./ one time",$temp)){?> checked="checked"<?php }?> > Occ./ reg./ one time
        ...
        <input type="checkbox" value="Asap/ start date" name="availability[]" <?php if(in_array("Asap/ start date",$temp)){?> checked="checked"<?php }?>> Asap/ start date
        <input type="checkbox" value="Evening" name="availability[]" <?php if(in_array("Evening",$temp)){?> checked="checked"<?php }?>> Evening
        <input type="checkbox" value="Weekends/ Shabbos" name="availability[]" <?php if(in_array("Weekends/ Shabbos",$temp)){?> checked="checked"<?php }?>> Weekends/ Shabbos
        <input type="checkbox" value="Night Nurse" name="availability[]" <?php if(in_array("Night Nurse",$temp)){?> checked="checked"<?php }?>> Night Hours
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	 ...
	 <div class="ad-manager-full-input">
	 	<input type="checkbox" value="CPR" name="training[]" <?php if(in_array('CPR',$trainingtemp)){?> selected="selected"<?php } ?>> CPR
	    <input type="checkbox" value="First Aid" name="training[]" <?php if(in_array('First Aid',$trainingtemp)){?> selected="selected"<?php } ?>> First Aid
	    <input type="checkbox" value="Nanny/ Babysitter course" name="training[]" <?php if(in_array('Nanny/ Babysitter course',$trainingtemp)){?> selected="selected"<?php } ?>> Nanny/ Babysitter course
	    <input type="checkbox" value="Not necessary" name="training[]" <?php if(in_array('Not necessary',$trainingtemp)){?> selected="selected"<?php } ?>> Not necessary
	 </div>
</div>
<div class="form-group">
...
<div class="form-group">
 	...
 	<div class="ad-manager-full-input"><input type="checkbox" value="1" name="driver_license" <?php if($detail[0]['driver_license'] == 1){?> checked="checked" <?php }?> ></div>
</div> 
<div class="form-group">
 	<label class="control-label">Vehicle</label>
 	<div class="ad-manager-full-input"><input type="checkbox" value="1" name="vehicle" <?php if($detail[0]['vehicle'] == 1){?> checked="checked" <?php }?>></div>
</div>
<div class="form-group">
	<label class="control-label">Must be willing to pick up kids from school</label>
	<div class="ad-manager-full-input"> <input type="checkbox" value="1" name="pick_up_child" <?php if($detail[0]['pick_up_child'] == 1){?> checked="checked" <?php }?>></div>
</div>
<div class="form-group">
	<label class="control-label">Must be willing to cook/ serve meals</label>
	<div class="ad-manager-full-input"><input type="checkbox" value="1" name="cook" <?php if($detail[0]['cook'] == 1){?> checked="checked" <?php }?>></div>
</div>
<div class="form-group">
	<label class="control-label">Must be willing to do light housework/ cleaning</label>
	<div class="ad-manager-full-input"><input type="checkbox" value="1" name="basic_housework" <?php if($detail[0]['basic_housework'] == 1){?> checked="checked" <?php }?>></div>
</div>
<div class="form-group">
	<label class="control-label">Must be willing to help with homework</label>
	<div class="ad-manager-full-input"><input type="checkbox" value="1" name="homework_help" <?php if($detail[0]['homework_help'] == 1){?> checked="checked" <?php }?>></div>
</div>
<div class="form-group">
	<label class="control-label">Must be willing to care for sick child</label>
	<div class="ad-manager-full-input"><input type="checkbox" value="1" name="sick_child_care" <?php if($detail[0]['sick_child_care'] == 1){?> checked="checked" <?php }?>></div>
</div>
<div class="form-group">
	<label class="control-label">Must have references</label>
	<div class="ad-manager-full-input"><input type="checkbox" value="1" name="references" <?php if($detail[0]['references'] == 1){?> checked="checked" <?php }?>></div>
</div>
<div class="form-group">
	<label class="control-label">Photo of child/ children</label>
	<div class="ad-manager-full-input"><input type="checkbox" value="1" name="photo_of_child" <?php if($detail[0]['photo_of_child'] == 1){?> checked="checked" <?php }?>></div>
</div>
