...
<div class="form-group">
	...
	<div class="ad-manager-full-input"><input type="checkbox" value="Alz." name="willing_to_work[]" <?php if(in_array('Alz.',$willing_to_work)){?> checked="checked" <?php }?>> Alz.
...
<div class="form-group">
	...
	<div class="ad-manager-full-input"><div class="ad-manager-full-input">
...
<div class="form-group">
	<label class="control-label"></label>
	<div class="ad-manager-full-input">
		<input type="checkbox" value="1" name="cook" <?php if($detail[0]['cook'] == 1){?> checked <?php }?> >Must be willing to cook/ serve meals
		<input type="checkbox" value="1" name="basic_housework" <?php if($detail[0]['basic_housework'] == 1){?> checked <?php }?>>Must be willing to do light housework/ cleaning
