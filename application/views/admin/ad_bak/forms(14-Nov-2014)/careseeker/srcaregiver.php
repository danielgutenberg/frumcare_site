...
<div class="form-group">
	...
	<div class="ad-manager-full-input">
		<input type="checkbox" value="CPR" name="training[]" <?php if($detail[0]['training']){?> checked="checked" <?php }?> > CPR
        <input type="checkbox" value="First Aid" name="training[]" <?php if($detail[0]['training']){?> checked="checked" <?php }?> > First Aid
        <input type="checkbox" value="Nanny/ Babysitter course" name="training[]" <?php if($detail[0]['training']){?> checked="checked" <?php }?> > Nanny/ Babysitter course
