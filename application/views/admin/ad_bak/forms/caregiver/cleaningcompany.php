...
<?php 
	...
	<div class="ad-manager-checkbox">
		<div><input type="checkbox" value="Floors" name="willing_to_work[]" <?php if(in_array('Floors', $temp)){?> checked="checked" <?php }?>> Floors</div>
	    <div><input type="checkbox" value="Windows" name="willing_to_work[]" <?php if(in_array('Windows', $temp)){?> checked="checked" <?php }?>> Windows</div>
	    <div><input type="checkbox" value="Dishes" name="willing_to_work[]" <?php if(in_array('Dishes', $temp)){?> checked="checked" <?php }?>> Dishes</div>
	    <div><input type="checkbox" value="Laundry" name="willing_to_work[]" <?php if(in_array('Laundry', $temp)){?> checked="checked" <?php }?>> Laundry</div>
	    <div><input type="checkbox" value="Wash" name="willing_to_work[]" <?php if(in_array('Wash', $temp)){?> checked="checked" <?php }?>> Wash</div>
	    <div><input type="checkbox" value="Fold" name="willing_to_work[]" <?php if(in_array('Fold', $temp)){?> checked="checked" <?php }?>> Fold</div>
	    <div><input type="checkbox" value="Iron" name="willing_to_work[]" <?php if(in_array('Iron', $temp)){?> checked="checked" <?php }?>> Iron</div>
	    <div><input type="checkbox" value="Furniture" name="willing_to_work[]" <?php if(in_array('Furniture', $temp)){?> checked="checked" <?php }?>> Furniture</div>
	</div>
</div>
<div class="form-group">
	<?php 
