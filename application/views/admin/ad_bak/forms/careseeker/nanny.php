...
<div class="form-group">
	...
	<div class="ad-manager-checkbox">
		<input type="checkbox" value="Occ./ reg./ one time" name="availability[]" <?php if(in_array('Occ./ reg./ one time',$availability)){?> checked="checked"<?php }?> > Occ./ reg./ one time<br/>
        ...
        <input type="checkbox" value="Asap/ start date" name="availability[]" <?php if(in_array('Asap/ start date',$availability)){?> checked="checked"<?php }?>> Asap/ start date<br/>
...
<div class="form-group">
	...
	<div class="ad-manager-checkbox">
		...
		<input type="checkbox" value="1" name="pick_up_child" <?php if($detail[0]['pick_up_child'] == 1){?> checked="checked" <?php }?> >Must be willing to pick up kids from school<br/>
		<input type="checkbox" value="1" name="cook" <?php if($detail[0]['cook'] == 1){?> checked="checked" <?php }?> >Must be willing to cook/ serve meals<br/>
		<input type="checkbox" value="1" name="basic_housework" <?php if($detail[0]['basic_housework'] == 1){?> checked="checked" <?php }?> >Must be willing to do light housework/ cleaning<br/>
		<input type="checkbox" value="1" name="homework_help" <?php if($detail[0]['homework_help'] == 1){?> checked="checked" <?php }?>>Must be willing to help with homework<br/>
		<input type="checkbox" value="1" name="sick_child_care" <?php if($detail[0]['sick_child_care'] == 1){?> checked="checked" <?php }?>>Must be willing to care for sick child<br/>
		<input type="checkbox" value="1" name="references" <?php if($detail[0]['references'] == 1){?> checked="checked" <?php }?>>Must have references<br/>
		<input type="checkbox" value="1" name="photo_of_child" <?php if($detail[0]['photo_of_child'] == 1){?> checked="checked" <?php }?> >Photo of child/ children<br/>
		<input type="checkbox" value="1" name="clean" <?php if($detail[0]['clean'] == 1){?> checked="checked" <?php }?>>Must be willing to clean<br/>
		<input type="checkbox" value="1" name="wash" <?php if($detail[0]['wash'] == 1){?> checked="checked" <?php }?>>Must be willing to wash<br/>
		<input type="checkbox" value="1" name="iron" <?php if($detail[0]['iron'] == 1){?> checked="checked" <?php }?> >Must be willing to iron<br/>
		<input type="checkbox" value="1" name="fold" <?php if($detail[0]['fold'] == 1){?> checked="checked" <?php }?> >Must be willing to fold<br/>
		<input type="checkbox" value="1" name="bath" <?php if($detail[0]['bath_children'] == 1){?> checked="checked" <?php }?> >Must be willing to bath<br/>
