        ...
        <div class="row">
               ...
               <?php $action = $this->uri->segment(3);?>
                   ...
                   <div class="panel-heading">
                    ...
                    <form role="form" action="<?php if($action=='add'){echo site_url('admin/admin/add_save');}else{echo site_url('admin/admin/edit_save');}?>" method="post" enctype="multipart/form-data" id="admin_add_edit_form">
                     	 ...
                     	 <div class="form-group">
                        	...
                        	<div class="ad-manager-select">
                        		<select class="form-control required" name="role">
                            		...
                            		<option value="superadmin" <?php if($action=="edit" && $role=="superadmin"){ echo "selected='selected'";} ?>>Super Admin</option>
                                    <option value="staff" <?php if($action=="edit" && $role=="staff"){ echo "selected='selected'";} ?>>Staff Admin</option>
                        		</select>
                        	</div>
                    	</div>
                        <?php if($action=="edit"):?>
                         <div class="form-group">
                           <div class="ad-manager-btns">
                                ...
                                <?php if(role($id)==1):?>
                                    <a href="<?php echo site_url('admin/admin/delete')."/".$id; ?>" class="btn btn-danger" title="Delete" onclick="return confirm('Are you sure to delete this admin?');">Delete
                                <?php endif?>
                            </div>
                        </div>
                        <?php endif?>
                         <div class="form-group">
                            ...
                            <input type="button" class="btn btn-default  btn-primary" value="Cancel" onclick="history.go(-1)" />
                            </div>
                        </div>
                    </form>
                </div>
