                                        ...
                                        foreach($data as $admins){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?php echo site_url('admin/adminrole/delete')."/".$admins['id']; ?>" class="btn btn-danger" title="Delete" onclick="return confirm('Are you sure to delete this admin?');">Delete
                                                </td>
                                            </tr>
                                            <?php
                                        }
