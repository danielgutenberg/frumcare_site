...
<div class="dashboard-wrapper"><div><a title="Dashboard" href="http://localhost/frumcare/admin/dashboard"><i class="fa fa-lg fa-fw fa-home"></i><span class="menu-item-parent">Dashboard</span></a></div>
  <div><a title="Admin" href="http://localhost/frumcare/admin/admin">
<i class="fa fa-lg fa-fw fa-user"></i>
<span class="menu-item-parent">Admin</span>
</a></div>

                <div><a title="Admin Role" href=""><i class="fa fa-lg fa-fw fa-group"></i> <span class="menu-item-parent">Admin Role</span></a></div>
           
                <div><a title="Page Manager" href="http://localhost/frumcare/admin/#"><i class="fa fa-lg fa-fw fa-file-o"></i> <span class="menu-item-parent">Page Manager</span></a></div>
            
                <div><a title="User Manager" href="http://localhost/frumcare/admin/user"><i class="fa fa-lg fa-fw fa-group"></i> <span class="menu-item-parent">User Manager</span></a></div>
           
                <div><a title="User Log Manager" href="http://localhost/frumcare/admin/user/logs"><i class="fa fa-lg fa-fw fa-group"></i> <span class="menu-item-parent">User Log Manager</span></a></div>
             
                <div><a title="User ProfilePicture Manager" href="http://localhost/frumcare/admin/user/profilepicture"><i class="fa fa-lg fa-fw fa-user"></i> <span class="menu-item-parent">User Profile Picture Manager</span></a></div>
            
                <div><a title="User Profile Configuration" href="http://localhost/frumcare/admin/user/profile"><i class="fa fa-lg fa-fw fa-group"></i> <span class="menu-item-parent">User Profile Manager</span></a></div>
            
              <div><a title="Email Template Manager" href="http://localhost/frumcare/admin/emailtemplate"><i class="fa fa-lg fa-fw fa-pencil-square"></i> <span class="menu-item-parent">Email Template Manager</span></a></div>
            
                <div><a title="Payment Manager" href="http://localhost/frumcare/admin/payment"><i class="fa fa-lg fa-fw fa-money"></i> <span class="menu-item-parent">Payment Manager</span></a></div>
            
                <div><a title="Ad Manager" href="http://localhost/frumcare/admin/ad"><i class="fa fa-lg fa-fw fa-money"></i> <span class="menu-item-parent">Ad Manager</span></a></div>
            
                <div><a title="Search Alert" href="http://localhost/frumcare/admin/searchalert"><i class="fa fa-lg fa-fw fa-th-large"></i> <span class="menu-item-parent">Search Alert</span></a></div>
            
                <div><a title="Package Manager" href="http://localhost/frumcare/admin/package"><i class="fa fa-lg fa-fw fa-ticket"></i> <span class="menu-item-parent">Package Manager</span></a></div>
            
                <div><a title="Feature Manager" href="http://localhost/frumcare/admin/feature"><i class="fa fa-lg fa-fw fa-th-large"></i> <span class="menu-item-parent">Feature Manager</span></a></div>
           
              <div><a title="Ticket Manager" href="http://localhost/frumcare/admin/ticket"><i class="fa fa-lg fa-fw fa-ticket"></i> <span class="menu-item-parent">Ticket Manager</span></a></div>
            
              <div><a title="Testimonial Manager" href="http://localhost/frumcare/admin/testimonial"><i class="fa fa-lg fa-fw fa-quote-left"></i> <span class="menu-item-parent">Testimonial Manager</span></a></div>
            
              <div><a title="General SEO Manager" href="http://localhost/frumcare/admin/#"><i class="fa fa-lg fa-fw fa-book"></i> <span class="menu-item-parent">General SEO Manager</span></a></div>
            
              <div><a title="Notification Manager" href="http://localhost/frumcare/admin/#"><i class="fa fa-lg fa-fw fa-quote-right"></i><span class="menu-item-parent">Notification Manager</span></a></div>
            </div>
               <?php /*  <div class="row">
                ...
                <!-- widget grid -->
               <?php /*  <section id="widget-grid" class="">
