...
<div class="dashboard-wrapper"><div><a title="Dashboard" href="http://localhost/frumcare/admin/dashboard"><i class="fa fa-lg fa-fw fa-home"></i><span class="menu-item-parent">Dashboard</span></a></div>
    <div>
        <a title="Admin" href="http://localhost/frumcare/admin/admin">
    ...
    ?>
        ...
        <div>
            <a title="User Manager" href="<?php echo $useraccess;?>>"><i class="fa fa-lg fa-fw fa-group"></i> <span class="menu-item-parent">User Manager</span></a>
        </div>
       
        <div>
            <a title="User Log Manager" href="<?php echo $logaccess;?>"><i class="fa fa-lg fa-fw fa-group"></i> <span class="menu-item-parent">User Log Manager</span></a>
        </div>
         
        <div>
            <a title="User ProfilePicture Manager" href="<?php echo $uprofileaccess;?>"><i class="fa fa-lg fa-fw fa-user"></i> <span class="menu-item-parent">User Profile Picture Manager</span></a>
        </div>
        
        <div>
            <a title="User Profile Configuration" href="<?php echo $uprofileaccess;?>"><i class="fa fa-lg fa-fw fa-group"></i> <span class="menu-item-parent">User Profile Manager</span></a>
        </div>
        
        <div>
            <a title="Email Template Manager" href="<?php echo $emailtemplate;?>"><i class="fa fa-lg fa-fw fa-pencil-square"></i> <span class="menu-item-parent">Email Template Manager</span></a>
        </div>
        
        <div>
            <a title="Payment Manager" href="<?php echo $payment;?>"><i class="fa fa-lg fa-fw fa-money"></i> <span class="menu-item-parent">Payment Manager</span></a>
        </div>
        
        <div>
            <a title="Ad Manager" href="<?php echo $ad;?>"><i class="fa fa-lg fa-fw fa-money"></i> <span class="menu-item-parent">Ad Manager</span></a>
        </div>
        
        <div>
            <a title="Search Alert" href="<?php echo $searchalert;?>"><i class="fa fa-lg fa-fw fa-th-large"></i> <span class="menu-item-parent">Search Alert</span></a>
        </div>
        
        <div>
            <a title="Package Manager" href="<?php echo $package;?>"><i class="fa fa-lg fa-fw fa-ticket"></i> <span class="menu-item-parent">Package Manager</span></a>
        </div>
        
        <div>
            <a title="Feature Manager" href="<?php echo $feature;?>"><i class="fa fa-lg fa-fw fa-th-large"></i> <span class="menu-item-parent">Feature Manager</span></a>
        </div>
        ...
        <div><a title="Notification Manager" href="<?php echo $notification;?>"><i class="fa fa-lg fa-fw fa-quote-right"></i><span class="menu-item-parent">Notification Manager</span></a></div>
            </div>
               <?php /*  <div class="row">
