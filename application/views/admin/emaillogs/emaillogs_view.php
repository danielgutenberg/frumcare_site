                                ...
                                else
                                {
                                    foreach($emaillogs as $cat)
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo 'User Id: ' . $cat['initiatedId'] . '<br>' . 'Email: ' . $cat['initiatedEmail']; if ($cat['full_path'])  {echo '<br>' . 'Attachment: yes';} if ($cat['reviewFor'])  {echo '<br>' . 'Review For:' . cat['reviewFor'];}?></td>
                                        </tr>
                                        <?php
                                    }
                                }
