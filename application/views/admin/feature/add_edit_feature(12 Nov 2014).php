            ...
            <div class="panel panel-default">
               ...
               <div class="panel-heading">
                ...
                <div class="form-group">
                        ...
                        <div class="ad-manager-full-input"><input type="text" class="form-control required" name="feature_name" value="<?php if(isset($name)){ echo $name;} ?>" /></div>
                    </div>
                    <div class="form-group">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <input type="submit" class="btn btn-primary " id="btn_save" name="save_feature" value="Save"/> 
                        </td>
                    </tr>
                </table>
