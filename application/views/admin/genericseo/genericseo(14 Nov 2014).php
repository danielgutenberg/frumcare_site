                        ...
                        <form role="form" id="page_add_edit_form" method="post" action="" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="ad-manager-full-input">
                                        <input type="radio" name="is_active" value="1" <?php echo $details['isActive']==1?'checked="checked"':''?>> Active
                                ...
                                <div class="form-group">
                                   <div class="ad-manager-btns">
                                        ...
                                        <input class="btn btn-primary btn-default" type="button" value="Cancel" onclick="history.go(-1);"/>
                                    </td>
                                </tr>
                        </form>
                    </div>
