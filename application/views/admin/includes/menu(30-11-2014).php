<aside id="left-panel">
      ...
      <nav>
        ...
        <ul>
            ...
            <li>
                <a href="<?php echo $admin;?>" title="Admin"><i class="fa fa-lg fa-fw fa-user"></i> <span class="menu-item-parent">Admin</span></a>
            </li>
            <li>
                <a href="<?php $adminrole;?>" title="Admin Role"><i class="fa fa-lg fa-fw fa-group"></i> <span class="menu-item-parent">Admin Role</span></a>
            </li>
            <li>
            ...
            <li>
                <a href="<?php echo $useraccess;?>" title="User Manager"><i class="fa fa-lg fa-fw fa-group"></i> <span class="menu-item-parent">User Manager</span></a>
            </li>
            <li>
                <a href="<?php echo $logaccess;?>" title="User Log Manager"><i class="fa fa-lg fa-fw fa-group"></i> <span class="menu-item-parent">User Log Manager</span></a>
            </li>
            <li>  
                <a href="<?php echo $ppaccess;?>" title="User ProfilePicture Manager"><i class="fa fa-lg fa-fw fa-user"></i> <span class="menu-item-parent">User Profile Picture Manager</span></a>
            </li>
            <li>
                <a href="<?php echo $uprofileaccess;?>" title="User Profile Configuration"><i class="fa fa-lg fa-fw fa-group"></i> <span class="menu-item-parent">User Profile Manager</span></a>
            </li>
            <li>
              <a href="<?php echo $emailtemplate;?>" title="Email Template Manager"><i class="fa fa-lg fa-fw fa-pencil-square"></i> <span class="menu-item-parent">Email Template Manager</span></a>
            </li>
            <li>
                <a href="<?php echo $payment;?>" title="Payment Manager"><i class="fa fa-lg fa-fw fa-money"></i> <span class="menu-item-parent">Payment Manager</span></a>
            </li>
            <li>
            ...
            <li>
                <a href="<?php echo $searchalert;?>" title="Search Alert"><i class="fa fa-lg fa-fw fa-th-large"></i> <span class="menu-item-parent">Search Alert</span></a>
            </li>
            <li>
                <a href="<?php echo $package;?>" title="Package Manager"><i class="fa fa-lg fa-fw fa-ticket"></i> <span class="menu-item-parent">Package Manager</span></a>
            </li>
            <li>
                <a href="<?php echo $feature;?>" title="Feature Manager"><i class="fa fa-lg fa-fw fa-th-large"></i> <span class="menu-item-parent">Feature Manager</span></a>
            </li>
            <li>
            ...
            <li>
              <a href="<?php echo $notification;?>" title="Notification Manager"><i class="fa fa-lg fa-fw fa-quote-right"></i><span class="menu-item-parent">Notification Manager</span></a>
            </li>
        </ul>
      </nav>
