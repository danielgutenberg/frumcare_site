            ...
            <div class="">
                ...
                <div class="panel-heading">
                  <h1 class="txt-color-blueDark">
                    <i class="fa fa-lg fa-fw fa-ticket"></i> <span>Package Manager</span>
                      ...
                      <div class="panel-body">
                        <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    if($data!=null)
                                    {
                                        foreach($data as $packages)
                                        {
                                            ?>
                                            <tr>
                                                <td><?php echo ucfirst($packages['package_name']);?></td>
                                                <td><?php echo '$'.$packages['package_price'].'.00';?></td>
                                                <td><?php echo $packages['package_duration'];?><?php echo ' '.$packages['duration_time'];?></td>
                                                <td>
                                                    <a href="<?php echo site_url('admin/package/edit')."/".$packages['id']; ?>" class="btn btn-info" title="Edit">Edit</a>
                                                    <a href="<?php echo site_url('admin/package/delete')."/".$packages['id']; ?>" class="btn btn-danger" title="Delete" onclick="return confirm('Are you sure to delete this package?');">Delete</a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
                            ...
                            <a class="btn btn-success" href="<?php echo site_url('admin/package/add'); ?>">Add Package</a>
                        </div>
