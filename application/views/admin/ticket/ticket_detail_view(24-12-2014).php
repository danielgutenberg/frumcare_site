        ...
        <span class="someinfo"><?php flash();?></span>
            ...
            <div class="panel-heading">
                ...
                <form role="form" id="ticket_reply">    
                    ...
                    <input class="btn btn-success reply" type="submit" value="+" <?php if($commentordetail['status'] == 1){?> disabled="disabled" <?php } ?>/> 
                </form>

             <?php /*    <?php if($next!=''){?><a href="<?php echo site_url();?>admin/ticket/view/<?php echo @$next['id'];?>">Next</a><?php } ?>| 
