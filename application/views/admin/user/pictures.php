                                ...
                                <tbody>
                                       ...
                                       $i=0;
                                            if(is_array($recordData)){
                                                foreach($recordData as $data):
                                                    $photo_url = base_url("images/no-image.jpg");
                                                        ...
                                                        if($data['photo_of_child']!="")
                                                                $photo_url = base_url('images/profile-picture/thumb/'.$data['photo_of_child']);

                                                        if(file_exists('images/profile-picture/'.$data['photo_of_child']) && $data['photo_of_child']!='')
                                                                $fullphoto = base_url('images/profile-picture/'.$data['photo_of_child']);
                                                        else
                                        ...
                                        ?>  <tr>
                                                ...
                                                <td>
                                                    <?php if($data['photo_status'] == 0) echo 'Approval Pending'; else echo 'Approved';?>
                                                </td>
                                                <td>
                                                    <?php if($data['photo_status'] == 0) $task =  'activate'; else $task = 'deactivate';?>
                                                    <a href="<?php echo site_url();?>admin/user/approve/<?php echo $data['id'];?>/<?php echo $task;?>" onclick="return confirm('Are you sure to <?php echo $task;?>?');"><?php if($data['photo_status'] == 0) echo 'Approve'; else echo 'Reject';?></a>
