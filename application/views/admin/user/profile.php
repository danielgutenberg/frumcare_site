                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h1 class="txt-color-blueDark">
                            <i class="fa fa-lg fa-fw fa-folder-open"></i> <span>User Manager</span>
                        </h1>
                    </div>
                                    ...
                                    <?php if(is_array($recordData)){
                                         foreach($recordData as $data):?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo site_url();?>admin/user/profile/view/<?php echo $data['id'];?>" class="btn btn-info">View</a>
                                                    <a href="<?php echo site_url();?>admin/user/delete/<?php echo $data['id'];?>" class="btn btn-danger" onclick="return confirm('Are sure to delete?');">Delete</a>
                                                </td>
                                            </tr>
                                      <?php endforeach;   
                                        } ?>
