                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <h1 class="txt-color-blueDark">
                       <i class="fa fa-lg fa-fw fa-folder-open"></i> <span>User Logs</span>
                       </h1>
                    </div>
                        ...
                        <div class="table-responsive">
                           <table id="dt_basic" class="table table-striped table-bordered table-hover">  
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <?php $user = get_user($ud['user_id']); ?>
                                        <td><?php echo $ud['user_id'];?>
                                        <td><?php echo $user['name']; ?></td>
                                        <td><?php echo date('Y/m/d h:i:s', $ud['login_time']); ?></td>
                                        <td><?php echo ($ud['logout_time']) ? date('Y/m/d h:i:s', $ud['logout_time']) : 'Not Logged Out'; ?></td>
                                        <td>
                                            <a href="<?php echo site_url();?>admin/user/logs/views/<?php echo $ud['id'];?>" class="btn btn-info">View</a>
                                            <a href="<?php echo site_url();?>admin/user/logs/delete/<?php echo $ud['id'];?>" onclick="return confirm('Are you sure to delete?');" class="btn btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                </tbody>    
