...
<tr><td>Level of observance necessary</td><td><?php
        echo $lev=$_POST['religious_observance'];

        ?></td></tr>
<tr><td>Age of Caregiver</td><td><?php echo $_POST['caregiverage_from'];?> to <?php echo $_POST['caregiverage_to'];?></td></tr>
<tr><td>Wage</td><td><?php
...
<tr><td>Smoker</td><td><?php $sm= $_POST['smoker']; echo $sm==1?'Yes':'No';?></td></tr>
<tr><td>Languages necessary</td><td><?php
        foreach($_POST['language'] as $r){
            echo $r.'<br>';
        }

        ?></td></tr>

<tr><td>Training necessary</td><td>

        <?php $tr=$_POST['training'];
        foreach($tr as $t){
            echo $t.'<br>';
        }
        ?>
...
<tr><td>Minimum experience</td>
    <td><?php echo $_POST['experience'];
       ?> Years
        ?></td>
</tr>
