...
<div id="loader" class="searchloader" style="display:none">
</div>
<?php 
...
<div id="locationField" style="display:none">
	...
	<h3>
		...
		Babysitter <span id="locationaddress"><?php echo $city;?></span>
	</h3>
		...
		$(document).ready(function(){
          ...
          $('#sortby1').change(function(){ 
			...
			if(inital_sortlimit){
				$.ajax({
					type:"get",
					url:"<?php echo site_url();?>babysitter/getPages",
					...
					success:function(data){
						for (i= 1; i<=data; i++) {
                  			...
                  			$('.navigations').append('<a href="<?php echo site_url();?>babysitter/pages/'+i+'"><span class="'+aclass+'">'+i+'</span></a>')
...
function fillInAddress() {
  ...
  var place = autocomplete.getPlace();
    ...
    document.getElementById('lng').value =  lng;
     ...
     //        }
     //    }
     //    xmlhttp.open("GET","<?php echo base_url().'caregivers/searchbylocation' ?>?latitude="+lat+"&longitude="+lng+"&account_category="+$('#acc_cat').val(),true);
     //    xmlhttp.send();
...
function myfunction(){
	...
	if((lat == '') && (lng == '')){
        ...
        xmlhttp.open("GET","<?php echo base_url().'babysitter/searchbylocation' ?>?latitude="+lat+"&longitude="+lng+"&location="+location,true);
        xmlhttp.send();
	}
