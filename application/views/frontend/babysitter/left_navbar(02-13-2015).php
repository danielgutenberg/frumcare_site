	 	...
	 	<form method="post" id="left-nav" action="">
 			...
 			<div class="select-services">
 				...
 				<select name="service" class="service required">
					...
					<?php }?>
					<?php if($cat == 'organization'){ ?>
						<option value="10">Day Care Center/Day Camp/Afternoon Activities</option>
						<option value="13">Senior Care Agency</option>
						<option value="14">Special needs center</option>
						<option value="15">Cleaning/ household help company</option>
						<option value="16">Senior Care Center/ Nursing Home</option>
					<?php }?>
 				</select>
	 		</div>
...
//		});
		...
		$('.service').change(function(){
            ...
            if(pagelink == 'Senior Care Center/ Nursing Home')
