...
if($detail){
    ...
    $gender_of_careseeker = explode(',', $detail['gender_of_careseeker']);
    $age = $user_detail['age'];
...
<form action="<?php echo site_url().'user/update_job_details/'.$care_type;?>" method="post"> 
    <div class="ad-form-container float-left">
        ...
        <div>
            ...
            <div class="form-field">
            <div class="radio-half"><input type="radio" value="1" name="gender_of_careseeker" <?php if(in_array('1',$gender_of_careseeker)){?> checked="checked" <?php } ?>> Male</div>
            <div class="radio-half"><input type="radio" value="2" name="gender_of_careseeker" <?php if(in_array('2',$gender_of_careseeker)){?> checked="checked" <?php } ?>> Female</div>
            <div class="radio-half"><input type="radio" value="3" name="gender_of_careseeker" <?php if(in_array('3',$gender_of_careseeker)){?> checked="checked" <?php } ?>> Both</div>
            </div>
        </div>
        <div>
