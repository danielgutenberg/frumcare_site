    ...
    echo form_hidden('organization_care',$record['organization_care']);
        ...
        <div class="ad-form-container">
            ...
            <div>
                ...
                <div class="first-block-checkbox"><div>
                    <input type="checkbox" value="Private home" name="looking_to_work[]"> <span>Private home</span></div>
                <div><input type="checkbox" value="Business/Office" name="looking_to_work[]"> <span>Business/Office</span></div></div>
        ...
        <select name="rate_type">
            ...
            <div>
                ...
                <div class="form-field">
                    ...
                    <div class="first-block-checkbox">
                        <div><input type="checkbox" value="Ironing" name="willing_to_work[]"> <span>Ironing</span></div>
                        <div><input type="checkbox" value="Cleaning and Dusting Furniture" name="willing_to_work[]"> <span>Cleaning and Dusting Furniture</span></div>
                    </div>
                    <div class="first-block-checkbox">
                        <div><input type="checkbox" value="Cleaning Refrigerator/Freezer" name="willing_to_work[]"><span>Cleaning Refrigerator/Freezer</span></div>
                        <div><input type="checkbox" value="Cleaning Oven/Stove" name="willing_to_work[]"><span>Cleaning Oven/Stove</span></div>
                    </div>
                    <div class="first-block-checkbox">
                        <div><input type="checkbox" value="Able to watch children as well" name="willing_to_work[]"><span>Able to watch children as well</span></div>
                        <div><input type="checkbox" value="Folding" name="willing_to_work[]"> <span>Folding</span></div>
                    </div>
                </div>
            </div>
            <div>
                ...
                <div class="form-field">
                    <div class="checkbox"><input type="checkbox" value="Imm" name="availability[]"/> Imm</div>
