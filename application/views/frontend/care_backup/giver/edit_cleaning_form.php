            ...
            <div>
                ...
                <div class="form-field">
                    <div class="first-block-checkbox"><div>
                        <input type="checkbox" value="Private home" name="looking_to_work[]" <?php if(in_array('Private home',$templookingtowork)){?> checked="checked" <?php }?>> <span>Private home</span></div>
                        <div><input type="checkbox" value="Business/Office" name="looking_to_work[]" <?php if(in_array('Business/Office',$templookingtowork)){?> checked="checked" <?php }?>> <span>Business/Office</span></div></div>
                        <div class="first-block-checkbox"><div><input type="checkbox" value="Cleaning company" name="looking_to_work[]" <?php if(in_array('Cleaning company',$templookingtowork)){?> checked="checked" <?php }?>> <span>Cleaning company</span></div>
                    </div>
                </div>
            </div>
            <div>
