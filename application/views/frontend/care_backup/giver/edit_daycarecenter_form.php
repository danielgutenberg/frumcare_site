...
<?php 
	if($detail){
		...
		$ref  = $detail[0]['references'];
	        ...
	        $refrence_file = $detail[0]['reference_file'];
	}
?>
    ...
    <form action ="<?php echo site_url().'user/update_job_details/'.$care_type;?>" method="post">
        <div class="ad-form-container float-left">
            ...
            <div>
                ...
                <div><input type="checkbox" name="language[]" value="English" <?php if(in_array('English', $lang)){?> checked="checked" <?php }?>> <span>English</span></div>
                <div><input type="checkbox" name="language[]" value="Spanish" <?php if(in_array('Spanish', $lang)){?> checked="checked" <?php }?>> <span>Spanish</span></div>
                </div>
                <div class="first-block-checkbox">
                <div><input type="checkbox" name="language[]" value="Sign Language" <?php if(in_array('Sign Language',$lang)){?> checked="checked" <?php }?>> <span>Sign Language</span></div>
                </div> -->
            ...
            <div>
                ...
                <option value="10-15" <?php echo isset($hr_rate) && $hr_rate == '10-15' ? 'selected' : '' ?>>$10-$15</option>
