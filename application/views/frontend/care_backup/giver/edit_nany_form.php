    ...
    <form action="<?php echo site_url().'user/update_job_details/'.$care_type;?>" method="post">
        <div class="ad-form-container float-left">
            ...
            <div>
                ...
                <div class="form-field">
                    ...
                    <!--<div class="checkbox"><input type="checkbox" value="Any" name="looking_to_work[]" <?php if(in_array('Any',$looking_to_work)){?> checked="checked" <?php } ?>> <span>Any</span></div>-->
                </div>
            </div>
            <div>
            ...
            <div>
                ...
                <div class="form-field">
                    ...
                    <div class="first-block-checkbox">
                        <div><input type="checkbox" value="Nanny/ Babysitter Course" name="training[]" <?php if(in_array('Nanny/ Babysitter Course', $training)){?> checked="checked" <?php } ?>> <span>Nanny/ Babysitter Course</span></div>
            ...
            <div class="rate-select">
	            ...
	            <select class="chargetype" name="rate_type">
	            <option value="1" <?php echo isset($rate_type) && $rate_type == '1'?'selected':'' ?>>Hourly Rate</option>
	            <option value="2" <?php echo isset($rate_type) && $rate_type == '2'?'selected':'' ?>>Monthly Rate</option><option value="3" <?php echo isset($rate_type) && $rate_type == '3'?'selected':'' ?>>Room and Board</option>
	        </select>
            </div>
        </div>
        ...
        <div class="refrence_file" <?php echo isset($reference_file) && $ref =='1' ?"":"style='display:none;'" ?>>
            ...
            <div class="checkbox-wrap">
                ...
                <div>
                    <input type="checkbox" value="1" name="wash" <?php echo isset($wash) && $wash == 1 ? 'checked' : ''?>> <label>Able to do laundry</label>
                </div>
                <div>
                    <input type="checkbox" value="1" name="iron" <?php echo isset($iron) && $iron == 1 ? 'checked' : ''?>> <label>Able to iron</label>
                </div>
                <div>
                    <input type="checkbox" value="1" name="fold" <?php echo isset($fold) && $fold == 1 ? 'checked' : ''?>> <label>Able to fold</label>
                </div>
                <div>
                    <input type="checkbox" value="1" name="bath_children" <?php echo isset($bath_children) && $bath_children == 1 ? 'checked' : ''?>> <label>Able to bathe children</label>
                </div>
                <div>
                    <input type="checkbox" value="1" name="bed_children" <?php echo isset($bed_children) && $bed_children == 1 ? 'checked' : ''?>> <label>Able to put children to bed</label>
                </div>
                <div>
