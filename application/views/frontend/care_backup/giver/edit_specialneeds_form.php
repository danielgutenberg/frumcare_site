        ...
        <div class="ad-form-container float-left">
            ...
            <div>
                ...
                <div class="form-field">
                    ...
                    <div class="checkbox"><input type="checkbox" value="Caregiving institute" name="looking_to_work[]" <?php if(in_array('Caregiving institute', $templookingtowork)){?> checked="checked" <?php }?>> Caregiving institude</div>
                </div>
            </div>
            <div>
            ...
            <div>
                ...
                <div class="form-field">
                    ...
                    <div class="first-block-checkbox">
                        <div><input type="checkbox" value="Special Needs Training" name="training[]" <?php if(in_array('Special Needs Training', $training)){?> checked="checked" <?php } ?>> <span>Special Needs Training</span></div>
            ...
            <div>
                ...
                <div class="form-field">
                    <div class="first-block-checkbox">
                        <div><input type="checkbox" value="Autism" name="willing_to_work[]" <?php if(in_array('Autism', $tempwillingtowork)){?> checked="checked" <?php }?>> <span>Autism</span></div>
                        <div><input type="checkbox" value="Down Syndrome" name="willing_to_work[]" <?php if(in_array('Down Syndrome', $tempwillingtowork)){?> checked="checked" <?php }?>> <span>Down Syndrome</span></div>
                    </div>
                    <div class="first-block-checkbox">
                        ...
                        <div><input type="checkbox" value="Handicapped" name="willing_to_work[]" <?php if(in_array('Handicapped', $tempwillingtowork)){?> checked="checked" <?php }?>> <span>Handicapped</span></div>
                    </div>
                </div>
            </div>
