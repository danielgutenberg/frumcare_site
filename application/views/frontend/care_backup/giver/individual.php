...
<div class="container">
    ...
    <div>
        ...
        <div class="form-field">
            <div class="radio-half"><input type="radio" name="marital_status" value="1"> Married</div>
            <div class="radio-half"><input type="radio" name="marital_status" value="2"> Single</div>
