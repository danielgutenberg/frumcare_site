...
<div class="container">
	...
	<form action="<?php echo site_url();?>ad/savejobdetails" method="post" enctype="multipart/form-data">
        ...
        <select name="rate_type">
            ...
            <option value="2">Monthly Rate</option><option value="3">Room and Board</option>
        </select>
				<div>
					<label>Availability (check one or more)</label>
					<div class="form-field">
						<div class="checkbox"><input type="checkbox" value="Imm" name="availability[]"/> Immediate</div>
						...
						<div class="checkbox"><input type="checkbox" value="Regulary" name="availability[]"> <span>Regularly</span></div>
				...
				<div>
                    ...
                    <div>Whats this? <a href="#">learn more</a></div>
				</div>
				...
				<div class="checkbox">
					<input type="checkbox" value="1" name="wash"> Able to do laundry
				</div>
				<div class="checkbox">
					<input type="checkbox" value="1" name="iron"> Able to iron
				</div>
				<div class="checkbox">
					<input type="checkbox" value="1" name="fold"> Able to fold
				</div>
				<div class="checkbox">
					<input type="checkbox" value="1" name="bath_children"> Able to bath children
				</div>
				<div class="checkbox">
