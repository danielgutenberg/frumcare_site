			...
			<div class="ad-form-container">
				...
				<div>
					...
					<div class="form-field">
						...
						<div class="checkbox"><input type="checkbox" value="Caregiving institude" name="looking_to_work[]"> <span>Caregiving Instution</span></div>
				...
				<div>
					...
					<div class="form-field">
						...
						<div class="first-block-checkbox">
							<div><input type="checkbox" value="Senior Care Training" name="training[]"> <span>Senior Care Training </span></div>
