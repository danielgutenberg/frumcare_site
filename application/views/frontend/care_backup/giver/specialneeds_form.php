			...
			<div class="ad-form-container">
				...
				<div>
					...
					<div class="form-field">
						...
						<div class="checkbox"><input type="checkbox" value="Caregiving institute" name="looking_to_work[]"> Caregiving institute</div>
					</div>
				</div>
				<div>
				...
				<div>
					...
					<div class="form-field">
						...
						<div class="first-block-checkbox">
							<div><input type="checkbox" value="Special Needs Training" name="training[]"> <span>Special Needs Training</span></div>
							<div><input type="checkbox" value="Nurse" name="training[]"> <span>Nurse</span></div>
						</div>
						<div class="first-block-checkbox">
				...
				<div>
					...
					<div class="form-field">
						...
						<div class="first-block-checkbox">
							<div><input type="checkbox" value="Handicapped" name="willing_to_work[]"> <span>Handicapped</span></div>
            ...
            <option value="2">Monthly Rate</option>
				...
				<div>
					...
					<div class="form-field">
						...
						<div class="checkbox full"><input type="checkbox" value="Start Date" name="availability[]" id="ckbox1"/>Start Date <input  type="text" name="start_date" id="textbox1" style="display: none;" autocomplete="off"/></div>
