    ...
    echo form_hidden('organization_care',$record['organization_care']);
        ...
        <div class="ad-form-container">
            ...
            <div>
                ...
                <div><input type="checkbox" value="Elementary school" name="subjects[]"> <span>Elementary school</span></div>
                <div><input type="checkbox" value="High school" name="subjects[]"> <span>High school</span></div>
                </div>

                <div class="first-block-checkbox">
                <div><input type="checkbox" value="Post high school" name="subjects[]"> <span>Post high school</span></div>
                <div><input type="checkbox" value="Special ed" name="subjects[]"> <span>Special ed</span></div>
                </div>

                <div class="first-block-checkbox">
                <div><input type="checkbox" value="limudei kodesh" name="subjects[]"> <span>Limudei Kodesh</span></div>
                <div><input type="checkbox" value="general studies" name="subjects[]"> <span>General Studies</span></div>
                </div>


                <div class="first-block-checkbox">
                <div><input type="checkbox" value="Music" name="subjects[]"> <span>Music</span></div>
                <div><input type="checkbox" value="Art" name="subjects[]"> <span>Art</span></div>
                </div>
                <div class="first-block-checkbox">
                <div><input type="checkbox" value="Ohter" name="subjects[]"> <span>Other</span></div>
                </div>
                </div>
            </div>
            <div>
                ...
                <div class="form-field">
                    <div class="first-block-checkbox">
                <div><input type="checkbox" value="Immediate" name="availability[]"/> Immediate<br />
            <input type="checkbox" value="Start Date" name="availability[]" id="ckbox1"/>Start Date
            <input  type="text" name="start_date" id="textbox1" style="display: none;"/></div>
                <div><input type="checkbox" value="occassionally" name="availability[]"> <span>Occassionally</span></div>
                </div>
                <div class="first-block-checkbox">
                <div><input type="checkbox" value="regularly" name="availability[]"><span>Regularly</span></div>
                ...
                <div class="first-block-checkbox">
                <div><input type="checkbox" value="By Appointment" name="availability[]"> <span>By Appointment</span></div>
                </div>
                </div>
            </div>
