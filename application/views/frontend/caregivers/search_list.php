	         ...
	         <div class="pin-location">
	        	...
	        	<div class="profile-list-details">
					<span class="name" style="word-wrap:250px">
						<a href="<?php echo site_url();?>caregivers/details/<?php echo $data['uri'];?>"><?php echo $data['first_name'];?> <?php echo $data['middle_name']?$data['middle_name']:'';?> <?php echo $data['last_name']?$data['last_name']:'';?></a>
					</span>
