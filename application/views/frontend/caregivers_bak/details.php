<div class="container">
<div id="fav_message" style="color: red;"></div>
	...
	<div class="caregivers-details">
		...
		<div class="details-right-caregive">
			<span><?php echo $recordData['first_name'];?> <?php echo $recordData['middle_name']?$recordData['middle_name']:'';?> <?php echo $recordData['last_name']?$recordData['last_name']:'';?></span>
			<br/>
				<div class="review_rating">
					<div class="rating-score" id="<?php echo round($number_reviews['total_review']/5);?>"></div>
			...
			<span class="location-wrap"><?php echo $recordData['city'].'<span>location</span>';?></span>
			...
			<span class="part-time-wrap">
				...
				<div class="clients-reviews-wrappers">
					...
					<div class="rating-review">
						...
						(<?php echo number_format($number_reviews['number_reviews']);?> Reviews)

						<br />

						<div class="reviewDetails">
								<?php if($number_reviews['number_reviews'] > 0){?>
								...
								<?php }else{?>
										See all <?php echo number_format($number_reviews['number_reviews']);?> customer reviews
								<?php } ?>
						</div></div>
					...
					<div class="nutshell">
						...
						<ul class="nutshells">
							<li>
								<?php if(@$recordData['age_group'] == '0-1'){?>
											<img src="<?php echo site_url();?>img/nut-list.png">
								<?php }else{ ?>
								<img src="<?php echo site_url();?>img/cross.png">
								<?php } ?>
							...
							<li>
							<?php if(@$recordData['age_group'] == '1-3'){?>
									<img src="<?php echo site_url();?>img/nut-list.png">
								<?php }else{ ?>
								<img src="<?php echo site_url();?>img/cross.png">
								<?php } ?>
						...
						<ul class="nutshells">
							<li>
								<?php if(@$recordData['age_group'] == '3-5'){?>
									<img src="<?php echo site_url();?>img/nut-list.png">
								<?php }else{ ?>
								<img src="<?php echo site_url();?>img/cross.png">
								<?php } ?>
							...
							<li>
								<?php if(@$recordData['age_group'] == '6-11'){?>
									<img src="<?php echo site_url();?>img/nut-list.png">
								<?php }else{ ?>
								<img src="<?php echo site_url();?>img/cross.png">
								<?php } ?>
						...
						<ul class="nutshells">
							<li>
								<?php if(@$recordData['age_group'] == '12+'){?>
									<img src="<?php echo site_url();?>img/nut-list.png">
								<?php }else{ ?>
								<img src="<?php echo site_url();?>img/cross.png">
								<?php } ?>
					...
					<div class="similiar-care">
						...
						<div class="similar-care-providers care-providers1">
							...
							<div class="name-care-providers">
								<?php echo trim($caregiver['first_name']);?><?php echo '&nbsp;';?><?php echo trim($caregiver['last_name']);?>
							</div>
					...
					<div class="references">
						...
						<div class="references1">
							<div class="names"><?php echo $value['reference_person'];?><span><?php echo $value['reference_text'];?></span></div>
							<div class="relationships"><strong>Relationship</strong>:<?php echo $value['relationship'];?></div>
							...
							<?php if(isset($this->session->userdata['current_user'])){
									...
									?>
								<a href="<?php echo $target;?>" class="contact_ref">Join Now to Contact Reference</a>
							</div>
			...
			<div class="right-sidebar-details">
				<p> 
					...
					if($days > 0) echo "( within " .$days." days ago)";
					elseif($hours > 0) echo "( within " .$hours." hours ago)";
					elseif($min > 0) echo "( within " .$min." minute ago)";
	...
	<span class="sidebar-name-btn"><a href="javascript:void(0);" class="btn btn-primary viewcontactdetails" id="<?php echo $id;?>"> Contact  <?php echo $recordData['first_name'];?> </a></span>
	<span class="view-availability-btn"><a href="#avail" class="btn btn-primary timetable"> View Availability</a></span>
				...
				<div>
					<table border="1" width="100%">
						...
						<tr>
							...
							<td align="center"> <?php if($availablility['late_morning_fri'] == 1){?><img src="<?php echo base_url();?>img/bullet.png"/> <?php }else{ ?><img src="<?php echo site_url();?>img/cross.png" /><?php }?></td>
							<td align="center" class="darks"> <?php if($availablility['late_morning_sat'] == 1){?><img src="<?php echo base_url();?>img/bullet.png"/> <?php }else{ ?><img src="<?php echo site_url();?>img/cross.png" /><?php }?></td>
						</tr>
						<tr>
					...
					<form class="usersreviewform">
						<table>
							<tr>
								...
								<td><input type="text" name="title" placeholder="Enter Title" value=""></td>
							</tr>
	...
	$('.favorite').on('click',function(){
		...
		$.ajax({
			...
			success:function(fav){
				console.log(fav);
                $('#fav_message').html("You favorite this profile")
			}
		});
	});
});
