<div class="container">
 <?php $this->load->view('frontend/careseeker_childcarefacility/left_navbar.php',$ipdata);?>
...
<?php if(is_array($ipdata)){?>
	...
	<h3>
	 ...
	 Workers / Staff for Childcare Facility <?php echo $count>1?"jobs":"job";?>
     <span id="locationaddress"><?php echo $city;?></span></h3>
...
<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			if(inital_sortlimit){
				$.ajax({
					type:"get",
					url:"<?php echo site_url();?>careseeker_childcarefacility/getPages",
					...
					success:function(data){
						for (i= 1; i<=data; i++) {
                  			...
                  			$('.navigations').append('<a href="<?php echo site_url();?>careseeker_childcarefacility/pages/'+i+'"><span class="'+aclass+'">'+i+'</span></a>')
				...
				$('.searchloader').fadeIn("fast");
				  ...
				  $.ajax({
				  		type:"get",
				  		url:"<?php echo site_url();?>careseeker_childcarefacility/sort_cate",
				  		//data:"limit="+per_page+"&order="+order,
                        data:"limit="+per_page+"&order="+order+"&care=care&care_type="+care_type,
							...
							var id = '<?php echo $this->uri->segment(3)?$this->uri->segment(3):1;?>';
								for (i= 1; i<=pagenum; i++) {
									if(i == id)
	                  				...
	                  				$('.navigations').append('<a href="<?php echo site_url();?>careseeker_nanny/pages/'+i+'"><span class="'+aclass+'">'+i+'</span></a>')
	            				}
				  		 }
...
//            }
//        }
//        xmlhttp.open("GET","<?php echo base_url().'careseeker_childcarefacility/searchbylocation' ?>?latitude="+lat+"&longitude="+lng,true);
//        xmlhttp.send();
...
function myfunction(){
	...
	if((lat == '') && (lng == '')){
        ...
        xmlhttp.open("GET","<?php echo base_url().'careseeker_childcarefacility/searchbylocation' ?>?latitude="+lat+"&longitude="+lng+"&location="+location,true);
        xmlhttp.send();
	}
