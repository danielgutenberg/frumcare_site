<?php echo $this->breadcrumbs->show();?>
			<h3><?php echo "Works/Staff for Childcare Facility"?></h3>  			
	 	...
	 	<form method="post" id="left-nav" action="">
 			...
 			<div class="neighborhood">
	 			<label style="">Neighborhood</label>
            ...
            <div>
                ...
                <div class="checkbox"><input type="checkbox" name="rate_type[]" class="rate_type" value="2">Global Monthly Payment</div>
            </div>
	 		<div>
                ...
                buttons: {
                  "OK": function () {
                    ...
                    var care_type = $('#care_type').val();
                        $.ajax({
                            type : "post",
                            url  : "<?php echo site_url();?>careseeker_childcarefacility/savesearch",
