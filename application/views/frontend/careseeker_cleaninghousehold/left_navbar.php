    	...
    	$(".searchloader").fadeIn("fast");
            ...
            var pagenum = $('#pagenum').val();
    			$.ajax({
    				...
    				data:"pagenum="+pagenum+"&lat="+lat+"&lng="+lng+"&location="+location+"&rate="+rate+"&rate_type="+rate_type+"&neighbour="+neighbour+"&gender_of_caregiver="+gender_of_caregiver+"&availability="+availability+"&looking_to_work="+looking_to_work+"&start_date="+start_date,
    ...
    $(document).ready(function(){
          ...
          $('#care_type').val(care_type);
            ...
            var distance = $('#sort_by_miles').val();
                        $.ajax({
                            type : "post",
                            url  : "<?php echo site_url();?>careseeker_cleaninghousehold/savesearch",
                            data:"lat="+lat+"&lng="+lng+"&location="+location+"&distance="+distance+"&rate="+rate+"&rate_type="+rate_type+"&neighbour="+neighbour+"&gender_of_caregiver="+gender_of_caregiver+"&availability="+availability+"&looking_to_work="+looking_to_work+"&start_date="+start_date+"&care_type="+care_type,
