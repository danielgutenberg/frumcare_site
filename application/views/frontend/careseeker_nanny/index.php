<div class="container">
 <?php $this->load->view('frontend/careseeker_nanny/left_navbar.php',$ipdata);?>
...
<?php if(is_array($ipdata)){?>
	...
	<h3>
	 ...
	 Nanny / Au-Pair <?php echo $count>1?"jobs":"job";?>
...
<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			if(inital_sortlimit){
				$.ajax({
					type:"get",
					url:"<?php echo site_url();?>careseeker_nanny/getPages",
				...
				$('.searchloader').fadeIn("fast");
				  ...
				  $.ajax({
				  		type:"get",
				  		url:"<?php echo site_url();?>careseeker_nanny/sort_cate",
...
//            }
//        }
//        xmlhttp.open("GET","<?php echo base_url().'careseeker_nanny/searchbylocation' ?>?latitude="+lat+"&longitude="+lng,true);
//        xmlhttp.send();
...
function myfunction(){
	...
	if((lat == '') && (lng == '')){
        ...
        xmlhttp.open("GET","<?php echo base_url().'careseeker_nanny/searchbylocation' ?>?latitude="+lat+"&longitude="+lng+"&location="+location,true);
        xmlhttp.send();
	}
