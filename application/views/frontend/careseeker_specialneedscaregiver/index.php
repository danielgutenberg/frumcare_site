<div class="container">
 <?php $this->load->view('frontend/careseeker_specialneedscaregiver/left_navbar.php',$ipdata);?>
...
<?php if(is_array($ipdata)){?>
	...
	<h3>
	 ...
	 Special Needs Caregiver <?php echo $count>1?"jobs":"job";?>
...
<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			if(inital_sortlimit){
				$.ajax({
					type:"get",
					url:"<?php echo site_url();?>careseeker_specialneedscaregiver/getPages",
					...
					success:function(data){
						for (i= 1; i<=data; i++) {
                  			...
                  			$('.navigations').append('<a href="<?php echo site_url();?>careseeker_specialneedscaregiver/pages/'+i+'"><span class="'+aclass+'">'+i+'</span></a>')
				...
				$('.searchloader').fadeIn("fast");
				  ...
				  $.ajax({
				  		type:"get",
				  		url:"<?php echo site_url();?>careseeker_specialneedscaregiver/sort_cate",
...
//            }
//        }
//        xmlhttp.open("GET","<?php echo base_url().'careseeker_specialneedscaregiver/searchbylocation' ?>?latitude="+lat+"&longitude="+lng,true);
//        xmlhttp.send();
...
function myfunction(){
	...
	if((lat == '') && (lng == '')){
        ...
        xmlhttp.open("GET","<?php echo base_url().'careseeker_specialneedscaregiver/searchbylocation' ?>?latitude="+lat+"&longitude="+lng+"&location="+location,true);
        xmlhttp.send();
	}
