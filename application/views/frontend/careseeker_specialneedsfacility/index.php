<div class="container">
 <?php $this->load->view('frontend/careseeker_specialneedsfacility/left_navbar.php',$ipdata);?>
...
<div class="right-caregivers">
	...
	<h3>
		<span id="total"><?php 
			...
			echo $count;
		?> </span>
	 specialneedsfacility <?php echo $count>1?"jobs":"job";?> <span id="locationaddress"><?php echo $city;?></span></h3>
...
<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			if(inital_sortlimit){
				$.ajax({
					type:"get",
					url:"<?php echo site_url();?>careseeker_specialneedsfacility/getPages",
					...
					success:function(data){
						for (i= 1; i<=data; i++) {
                  			...
                  			$('.navigations').append('<a href="<?php echo site_url();?>careseeker_specialneedsfacility/pages/'+i+'"><span class="'+aclass+'">'+i+'</span></a>')
				...
				$('.searchloader').fadeIn("fast");
				  ...
				  $.ajax({
				  		type:"get",
				  		url:"<?php echo site_url();?>careseeker_specialneedsfacility/sort_cate",
...
//            }
//        }
//        xmlhttp.open("GET","<?php echo base_url().'careseeker_specialneedsfacility/searchbylocation' ?>?latitude="+lat+"&longitude="+lng,true);
//        xmlhttp.send();
...
function myfunction(){
	...
	if((lat == '') && (lng == '')){
        ...
        xmlhttp.open("GET","<?php echo base_url().'careseeker_specialneedsfacility/searchbylocation' ?>?latitude="+lat+"&longitude="+lng+"&location="+location,true);
        xmlhttp.send();
	}
