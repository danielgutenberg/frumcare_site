	...
	<div class="profile-img-wrap">
	        ...
	        <?php } ?> 
	        	...
	        	<div class="profile-list-details">
					<span class="name">
						<a href="<?php echo site_url();?>careseekers/details/<?php echo $data['uri'];?>"><?php echo $data['first_name'];?> <?php echo $data['middle_name']?$data['middle_name']:'';?> <?php echo $data['last_name']?$data['last_name']:'';?></a>
					</span>
...
<div class="line"></div>
					...
					<a href="<?php echo site_url();?>therapists/details/<?php echo $data['uri'];?>" style="color:#98C85A">More</a>
					<br />
					<h5>Last Signed in:
					...
					<div class="profile-activities">
						<?php if($data['job_type'] == 1){ ?>
					 	...
					 	<a href="<?php echo site_url();?>careseekers/details/<?php echo $data['uri'];?>" class="btn btn-primary">See full Profile</a>
				</div>
		</div>
