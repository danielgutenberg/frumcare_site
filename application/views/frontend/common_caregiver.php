...
<script>
	...
	$(document).ready(function(){
        ...
        $('.number_of_children,.year_experience,.age_group,#textbox1,.sub_care,#per_page,#sort_by_miles,#sort_by_select').change(function(){
			$(".searchloader").fadeIn("fast");
			$('#pagenum').val(1);
            filterCaregivers();
		});
