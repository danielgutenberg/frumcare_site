 <div class="container">
 <?php $this->load->view('frontend/daycarecenter/left_navbar',$ipdata);?>
...
<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			if(inital_sortlimit){
				$.ajax({
					type:"get",
					url:"<?php echo site_url();?>daycarecenter/getPages",
					...
					success:function(data){
						for (i= 1; i<=data; i++) {
                  			...
                  			$('.navigations').append('<a href="<?php echo site_url();?>daycarecenter/pages/'+i+'"><span class="'+aclass+'">'+i+'</span></a>')
...
//            }
//        }
//        xmlhttp.open("GET","<?php echo base_url().'daycarecenter/searchbylocation' ?>?latitude="+lat+"&longitude="+lng,true);
//        xmlhttp.send();
...
function myfunction(){
	...
	if((lat == '') && (lng == '')){
        ...
        xmlhttp.open("GET","<?php echo base_url().'daycarecenter/searchbylocation' ?>?latitude="+lat+"&longitude="+lng+"&location="+location,true);
        xmlhttp.send();
	}
