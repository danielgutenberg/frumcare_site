...
<br />
<div style="text-align:center;font-family:Arial, Helvetica, sans-serif; font-size:18px; margin-bottom:5px;"><a href="<?php echo site_url() . $navigate . '/' . $care_name;?>">Click here</a> to see more <?php echo $ad; ?></div>
