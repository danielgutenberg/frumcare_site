...
<div style="font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px;">To APPROVE: <a href="<?php echo site_url();?>ad/approveAd/<?php echo $recordData['user_id'];?>/<?php echo $recordData['care_type'];?>">Click Here</a></div>
