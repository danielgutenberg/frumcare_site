...
<br />
    ...
    <div style="font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px;">To view ad on frumcare.com: <a href="<?php echo site_url().$navigate; ?>/details/<?php echo $recordData['uri'];?>/<?php echo $recordData['care_type'];?>">Click Here</a></div>
<br />
