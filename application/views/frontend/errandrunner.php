        ...
        <div class="col-lg-4 col-md-3 col-sm-12 col-xs-12">
            ...
            <div>
                <select>
                    ...
                    <option selected>Errand Runner / Odd Jobs</option>
                </select>
            </div>
            <div>
            ...
            <div>
                <label>Smoking</label>
                <div class="radio"><input type="radio" value="1" name="smoker"/>Yes</div>
                <div class="radio"><input type="radio" value="0" name="smoker"/>No</div>
            </div>
            <div>
