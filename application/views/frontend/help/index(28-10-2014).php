            ...
            <div class="row">
                    <article>
                        <div class="help-content">
                        	<a herf="#" class="btn btn-primary btn-lg">Ask Our Community</a>
                        </div>
                    </article>
            </div>
        </div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="ticket" enctype="multipart/form-data" method="post">	
					...
					<input type="text" name="ticket_title" class="ticket_title">
					...
					<input type="file" name="file_upload" id="file_upload" style="display: none;"> <div id="output" class="loader"></div>
					<br/>
					...
					<div class="modal-footer">
					 ...
					 <button type="button" class="btn btn-primary save_ticket">Save Changes</button>
					</div>
				</form>
				<div id="success"></div>
			</div>
 ...
 // jquery form-validation goes here
    $(function() {
		...
		$('.save_ticket').click(function(){
			if ($('.ticket_title').val()==="") {
      			$('.ticket_title').next('.help-inline').show();
      			return false;
    		}else {
		      $.ajax({
		    		   	type: "POST",
