		...
		<div class="top-part">
			<div class="caregiver-contacts-wrap">
				<div class="caregiver-contacts">
					<span>Caregivers will contact<br/> you within 3 days,<br/>guaranteed.</span>
				</div>
			</div>
			<div class="interview-check-wrap">
				...
				<div class="looking-caregiver">
					...
					<div class="pay-for-care"><span><a href="#">pay for your care</a></span></div>
					<div class="find-caregivers"><span><a href="#">find caregivers</a></span></div>
				</div>
				<div class="clearfix"></div>
			...
			<div class="bottom-part">
				...
				<div class="interview-check-wrap">
					...
					<div class="looking-for-job">
						...
						<div class="pay-for-care"><span><a href="#">get paid</a></span></div>
						<div class="find-jobs"><span><a href="#">find jobs</a></span></div>
					</div>
					<div class="clearfix"></div>
					<div class="create-account-wrap"><div class="create-account"><span>Create an account.<br/>It's easy.</span></div></div>
					<div class="job-posted-wrap"><div class="job-posted"><span>New jobs are posted<br/>every minute!</span></div></div>
