            ...
            <div class="col-one-fourth">
                <div class="footer-navigation">
                    <nav>
                        ...
                        <ul>
                            <li><a href="<?php echo site_url();?>careseekers">Jobs</a></li>
                ...
                <div class="footer-navigation">
                    <nav>
                        ...
                        <ul>
                            ...
                            <li><a href="<?php echo site_url();?>blog/resources">Advice and tips</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
            <div class="col-one-fourth">
                <div class="footer-navigation contactus">
                    <nav>
                        ...
                        <ul>
                            <li><a href="#"><i class="icon-mobile"></i>111-222-333</a></li>
