                ...
                <div class="footer-navigation">
                    <nav>
                        ...
                        <ul>
                            ...
                            <li><a href="<?php echo site_url();?>careseekers">Recruit Workers</a></li>
                ...
                <div class="footer-navigation">
                    <nav>
                        ...
                        <ul>
                            ...
                            <li><a href="<?php echo site_url();?>blog/resources">Staying Safe</a></li>
                            <li><a href="<?php echo site_url();?>blog/resources">Tips and Tools</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
                ...
                <div class="footer-navigation contactus">
                    <nav>
                        ...
                        <ul>
                            ...
                            <li><input type="submit" id="subscribe" value="Subscribe" class="btn btn-primary btn-sm"/></li>
                        </ul>
                    </nav>
                </div>
            </div>
