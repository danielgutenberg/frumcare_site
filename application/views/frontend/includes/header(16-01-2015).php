...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
     <?php 
     		$seodata  = Common_model::getSEODATA();
                            ...
                            <li>
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                    ...
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo site_url();?>caregivers">Find a Caregiver</a></li>
                                  </ul>
                                </div>
                            </li>
                            ...
                            <li>
                                 <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                    ...
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo site_url();?>careseekers">Find a Job</a></li>
                                  </ul>
                                </div>
                            </li>
                             ...
                             <li>
                                 <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                    ...
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo site_url();?>caregivers">Recruit Workers for Your Organization</a></li>
                                  </ul>
                                </div>
                            </li>
                             ...
                             <li>
                                 <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo site_url();?>signup">Advertise Your Services</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo site_url();?>therapists">Find a Therapist</a></li>
                                  </ul>
                                </div>
                            </li>
