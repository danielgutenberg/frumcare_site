				...
				<div class="clients-reviews-wrappers">
					...
					<div class="rating-review">
						...
						<?php 	if($number_reviews['number_reviews'] > 0){
								$url =  site_url();?>review/allreviews/<?php echo sha1($recordData['id']);
							}else{
								$url = "#";
							}
						?>
						<a href="<?php echo $url;?>">See all <?php echo number_format($number_reviews['number_reviews']);?> customer reviews</a>
						</div></div>
					...
					<div class="similiar-care">
						...
						<div class="similar-care-providers care-providers1">
							...
							<div class="name-care-providers"><?php echo trim($caregiver['first_name']);?><?php echo '&nbsp;';?><?php echo trim($caregiver['last_name']);?></div>
	...
	<div class="verification-sidebar">
		...
		<ul class="check-training">
			<li class="bbc">Basic Background Check
				...
				<?php if(($recordData['educational_institution']!= "")&&($recordData['education_level'] !="") && ($recordData['subjects']!="")){?>
				<div class="education-major-wrap">
					<div class="education-major">
						<h2>Education</h2>
							<div class="education-level">
								<span>Education Level:</span><?php if($recordData['education_level'] !=""){ echo ucwords($recordData['education_level']); }?>
							</div>
							<div class="texts">
								<?php if($recordData['educational_institution'] !=""){ echo ucwords($recordData['educational_institution']); }?>
							</div>
							<div class="education-levels">
								<span>Major:</span><?php if($recordData['subjects']!=""){ echo ucwords($recordData['subjects']);?><?php }?>
							</div>
					</div>
				</div>
				<?php  } ?>
