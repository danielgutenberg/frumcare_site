...
?> 	
	...
	<div class="profile-img-wrap">
			<?php if($data['profile_picture']!="" && file_exists('images/profile-picture/'.$data['profile_picture'])):?>
		            <a href="<?php echo site_url();?>instutions/details/<?php echo $data['uri'];?>"><div id="profile_image">
	        ...
	        <?php } ?> 
	        	...
	        	<div class="profile-list-details">
					<span class="name" style="word-wrap:250px">
						<a href="<?php echo site_url();?>instutions/details/<?php echo $data['uri'];?>"><?php echo $data['first_name'];?> <?php echo $data['middle_name']?$data['middle_name']:'';?> <?php echo $data['last_name']?$data['last_name']:'';?></a>
					</span>
...
<div class="line"></div>
					...
					<a href="<?php echo site_url();?>instutions/details/<?php echo $data['uri'];?>" style="color:#98C85A">More</a>
					<br />
					<h5>Last Signed in:
					...
					<div class="profile-activities">
						<?php if($data['job_type'] == 1){ ?>
					 	...
					 	<a href="<?php echo site_url();?>instutions/details/<?php echo $data['uri'];?>" class="btn btn-primary">See full Profile</a>
				</div>
		</div>
