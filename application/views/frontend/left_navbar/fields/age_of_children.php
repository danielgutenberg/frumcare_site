...
<div>
    ...
    <div class="checkbox first"><input type="checkbox" value="0-3" name="age_group[]" class="age_group"  <?php if(in_array('0-3',$age_group)){?> checked="checked" <?php } ?>> 0-3 months</div>
