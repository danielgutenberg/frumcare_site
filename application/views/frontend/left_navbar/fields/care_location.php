...
<div>
    ...
    <div class="checkbox"><input type="checkbox" value="Caregiving institution" class="looking_to_work"  <?php if(in_array('Caregiving institution',$location)){?> checked="checked" <?php } ?><?php echo ($this->uri->segment(1)=='caregivers' && ($this->uri->segment(2)=='workers-staff-for-childcare-facility'  || $this->uri->segment(3) == 'workers-staff-for-childcare-facility') )?'checked':'' ?> >Caregiving institution</div>
