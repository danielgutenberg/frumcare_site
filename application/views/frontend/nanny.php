<div class="container">
    <div class="row">
        <div class="col-lg-4 col-md-3 col-sm-12 col-xs-12">
            ...
            <div>
                <label>Number of childeren requireing care</label>
                <div>
                ...
                <div class="checkbox"><input type="checkbox" name="optional_number[]" value="twins"/>Twins </div>
                <div class="checkbox"><input type="checkbox" name="optional_number[]" value="triplets"/> Triplets</div>
            </div>
            <div>
                <label>Ages of children requiring care</label>
                ...
                <div class="checkbox"><input type="checkbox" name="age_group[]" value="1"/>1 year</div>
            ...
            <div>
                ...
                <div class="checkbox"><input type="checkbox" name="availability[]" value="Night Nurse"/>Night Nurse</div>
                <div class="checkbox"><input type="checkbox" name="availability[]" value="Weekends"/>Weekends</div>
                <div class="checkbox"><input type="checkbox" name="availability[]" value="Shabbos"/>Shabbos</div>
                <div class="checkbox"><input type="checkbox" name="availability[]" value="Vacation Sitter"/>Vacation Sitter</div>
                <div class="checkbox"><input type="checkbox" name="availability[]" value="Available on short notice"/>Available on short notice</div>
            </div>
            <div>
                ...
                <div class="checkbox"><input type="checkbox" value="1" name="bed_children"/>Able to put children to bed</div>
            </div>
            <div>
