 <div class="container">
 <?php $this->load->view('frontend/nanny/left_navbar.php',$ipdata);?>
...
<div class="searchloader" style="display:none">
	...
	<h3>
		...
		Nanny <span id="locationaddress"><?php echo $city;?></span>
	</h3>
...
<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			if(inital_sortlimit){
				$.ajax({
					type:"get",
					url:"<?php echo site_url();?>nanny/getPages",
					...
					success:function(data){
						for (i= 1; i<=data; i++) {
                  			...
                  			$('.navigations').append('<a href="<?php echo site_url();?>nanny/pages/'+i+'"><span class="'+aclass+'">'+i+'</span></a>')
...
function myfunction(){
	...
	if((lat == '') && (lng == '')){
        ...
        xmlhttp.open("GET","<?php echo base_url().'nanny/searchbylocation' ?>?latitude="+lat+"&longitude="+lng+"&location="+location,true);
        xmlhttp.send();
	}
