 <div class="container">
 <?php $this->load->view('frontend/nursery/left_navbar.php',$ipdata);?>
...
<div class="searchloader" style="display:none">
	...
	<h3>
		...
		Nursery/ Playgroup/ Drop off/ Gan 
...
//            }
//        }
//        xmlhttp.open("GET","<?php echo base_url().'nursery/searchbylocation' ?>?latitude="+lat+"&longitude="+lng,true);
//        xmlhttp.send();
...
function myfunction(){
	...
	if((lat == '') && (lng == '')){
        ...
        xmlhttp.open("GET","<?php echo base_url().'nursery/searchbylocation' ?>?latitude="+lat+"&longitude="+lng+"&location="+location,true);
        xmlhttp.send();
	}
