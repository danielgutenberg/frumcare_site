<?php if($this->uri->segment(1) == 'caregivers') { ?>
    <select id="careId" name="service" class="service care_type select2" style="width:95%" multiple="multiple" data-type="caregivers">
        ...
        <option value="3" <?php if(segment(2) == 'nursery-playgroup-drop-off-gan' || segment(3) == 'nursery-playgroup-drop-off-gan' || in_array(3, $careId)){?> selected="selected" <?php }?>>Nursery / Playgroup / Drop off / Gan</option>
        <option value="11" <?php if(segment(2) == 'day-care-center-day-camp-afternoon-activities' || segment(3) == 'day-care-center-day-camp-afternoon-activities' || in_array(11, $careId)){?> selected="selected" <?php }?>>Day Care Center / Day Camp / Afternoon Activities</option>
        ...
        <option value="13" <?php if(segment(2) == 'senior-care-agency' || segment(3) == 'senior-care-agency' || in_array(13, $careId)){?> selected="selected" <?php }?>>Senior Care Agency</option>                    
        ...
        <option value="14" <?php if(segment(2) == 'special-needs-center' || segment(3) == 'special-needs-center' || in_array(14, $careId)){?> selected="selected" <?php }?>>Special needs center</option>
        ...
        <option value="15" <?php if(segment(2) == 'cleaning-household-help-company' || segment(3) == 'cleaning-household-help-company' || in_array(15, $careId)){?> selected="selected" <?php }?>>Cleaning / household help company</option>
