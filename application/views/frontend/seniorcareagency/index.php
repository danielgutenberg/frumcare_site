 <div class="container">
 <?php $this->load->view('frontend/seniorcareagency/left_navbar',$ipdata);?>
...
<div class="searchloader" style="display:none">
	...
	<h3>
		...
		Senior care Agency <span id="locationaddress"><?php echo $city;?></span>
	</h3>
...
<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			if(inital_sortlimit){
				$.ajax({
					type:"get",
					url:"<?php echo site_url();?>seniorcareagency/getPages",
					...
					success:function(data){
						for (i= 1; i<=data; i++) {
                  			...
                  			$('.navigations').append('<a href="<?php echo site_url();?>seniorcareagency/pages/'+i+'"><span class="'+aclass+'">'+i+'</span></a>')
...
//            }
//        }
//        xmlhttp.open("GET","<?php echo base_url().'seniorcareagency/searchbylocation' ?>?latitude="+lat+"&longitude="+lng,true);
//        xmlhttp.send();
...
function myfunction(){
	...
	if((lat == '') && (lng == '')){
        ...
        xmlhttp.open("GET","<?php echo base_url().'seniorcareagency/searchbylocation' ?>?latitude="+lat+"&longitude="+lng+"&location="+location,true);
        xmlhttp.send();
	}
