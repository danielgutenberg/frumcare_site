<?php echo $this->breadcrumbs->show();?>
	 	...
	 	<form method="post" id="left-nav" action="">
	 		...
	 		<div>
	 			...
	 			<div class="checkbox"><input type="checkbox" name="willing_to_work[]" value="Yiddish" class="willing_to_work">Yiddish</div>
	 			<div class="checkbox"><input type="checkbox" name="willing_to_work[]" value="Hebrew" class="willing_to_work">Hebrew</div>
	 			<div class="checkbox"><input type="checkbox" name="willing_to_work[]" value="Russian" class="willing_to_work">Russian</div>
	 			<div class="checkbox"><input type="checkbox" name="willing_to_work[]" value="French" class="willing_to_work">French</div>
	 			<div class="checkbox"><input type="checkbox" name="willing_to_work[]" value="Other" class="willing_to_work">Other</div>
	 		</div>
