        ...
        <form role="form" id="sign-up" action="<?php echo base_url($action) ?>" method="post">
         <div class="care-type clearfix">I am a</div>
                <div class="form-field">
                        <input type="radio" name="account_category" value="1" <?php if($at == 1 ){?> checked="checked" <?php } ?> class="acc_cat"> Caregiver
                        <input type="radio" name="account_category" value="2" <?php if($at == 2 ){?> checked="checked" <?php } ?> class="acc_cat"> Careseeker
                </div>
...
<script type="text/javascript">
    $(function(){
        ...
        var account_category = $('.acc_cat:checked').val();
