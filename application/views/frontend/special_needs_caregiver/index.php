 <div class="container">
 <?php $this->load->view('frontend/special_needs_caregiver/left_navbar',$ipdata);?>
...
<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			if(inital_sortlimit){
				$.ajax({
					type:"get",
					url:"<?php echo site_url();?>special_needs_caregiver/getPages",
					...
					success:function(data){
						for (i= 1; i<=data; i++) {
                  			...
                  			$('.navigations').append('<a href="<?php echo site_url();?>special_needs_caregiver/pages/'+i+'"><span class="'+aclass+'">'+i+'</span></a>')
...
//            }
//        }
//        xmlhttp.open("GET","<?php echo base_url().'special_needs_caregiver/searchbylocation' ?>?latitude="+lat+"&longitude="+lng,true);
//        xmlhttp.send();
...
function myfunction(){
	...
	if((lat == '') && (lng == '')){
        ...
        xmlhttp.open("GET","<?php echo base_url().'special_needs_caregiver/searchbylocation' ?>?latitude="+lat+"&longitude="+lng+"&location="+location,true);
        xmlhttp.send();
	}
