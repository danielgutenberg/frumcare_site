<?php echo $this->breadcrumbs->show();?>
			<h3>
					<?php echo ucwords(str_replace('_', ' ',segment(1))); ?>
			</h3>  			
	 	...
	 	<form method="post" id="left-nav" action="">
	 		...
	 		<?php /*<div>
 				...
 				<div class="checkbox"><input type="checkbox" name="carelocation" class="carelocation" value="Caregiving Instution">Caregiving Instution</div>
	 		</div> */ ?>
