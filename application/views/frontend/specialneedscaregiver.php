<div class="container">
    <div class="row">
        <div class="col-lg-4 col-md-3 col-sm-12 col-xs-12">
            <div><h3>Special Needs Caregiver</h3></div>
            <h4>Refine Result</h4>
            ...
            <div>
                <select>
                    ...
                    <option selected>Special Needs Caregiver</option>
            ...
            <div>
                ...
                <div class="checkbox"><input type="checkbox" name="willing_to_work[]" value="Autism"/>Autism</div>
                <div class="checkbox"><input type="checkbox" name="willing_to_work[]" value="Down Syndrome"/>Down Syndrome</div>
                <div class="checkbox"><input type="checkbox" name="willing_to_work[]" value="Handicapped"/>Handicapped</div>
            ...
            <div>
                ...
                <div class="checkbox"><input type="checkbox" name="availability[]" value="Overnight"/>Overnight</div>                
