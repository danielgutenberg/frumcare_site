 <div class="container">
 <?php $this->load->view('frontend/specialneedscenter/left_navbar',$ipdata);?>
...
<div class="searchloader" style="display:none">
	...
	<h3>
		...
		Special needs Center <span id="locationaddress"><?php echo $city;?></span>
	</h3>
...
//            }
//        }
//        xmlhttp.open("GET","<?php echo base_url().'specialneedscenter/searchbylocation' ?>?latitude="+lat+"&longitude="+lng,true);
//        xmlhttp.send();
...
function myfunction(){
	...
	if((lat == '') && (lng == '')){
        ...
        xmlhttp.open("GET","<?php echo base_url().'specialneedscenter/searchbylocation' ?>?latitude="+lat+"&longitude="+lng+"&location="+location,true);
        xmlhttp.send();
	}
