			...
			$('.neighbour').blur(function(){
			 $(".searchloader").fadeIn("fast");
			    	...
			    	$.ajax({
			    		...
			    		data:"neighbour="+neighbour+"&caregiverage_from="+caregiverage_from+"&caregiverage_to="+caregiverage_to+"&languages="+lang+"&observance="+observance+"&accept_insurance="+accept_insurance+"&gender="+gender+"&care_type="+care_type,
