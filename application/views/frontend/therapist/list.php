...
?> 	
	...
	<div class="profile-img-wrap">
			<?php if($data['profile_picture']!="" && file_exists('images/profile-picture/'.$data['profile_picture'])):?>
	            ...
	            <a href="<?php echo site_url();?>therapists/details/<?php echo $data['uri'];?>/<?php echo $data['care_type'];?>">
	        ...
	        <div class="pin-location">
	        	...
	        	<div class="profile-list-details">
					<span class="name">
						<a href="<?php echo site_url();?>therapists/<?php echo $data['uri'];?>/<?php echo $data['care_type'];?>">
							<?php echo $data['name'];?>
						</a>
					</span>
						<?php 
							$data['total_rating'] = 0;
							$reviewData['number_of_reviews'] = 0;

						?>
						<div class="rating-score" id="<?php echo round($reviewData['total_review'] / 5);?>"></div>

						(<?php echo number_format($reviewData['number_of_reviews']);?> reviews)
...
<div class="line"></div>
					...
					<div class="profile-activities">
						<?php if($data['job_type'] == 1){ ?>
					 	...
					 	<a href="<?php echo site_url();?>therapists/details/<?php echo $data['uri'];?>/<?php echo $data['care_type'];?>" class="btn btn-primary">See full Profile</a>
				</div>
		</div>
