                    ...
                    <div class="sign-up-form">
                        <form name="myform" id="myform">
                            ...
                            <div class="form-field organizational_care" style="display:none">
                                <div class="radio"><label><input type="radio" name="organization_care" value="1" class="org_caretype required" id="2">Advertise My Service</label></div>
                                <div class="radio"><label><input type="radio" name="organization_care" value="2" class="org_caretype required" id="2">Find Workers</label></div>
                            </div>
