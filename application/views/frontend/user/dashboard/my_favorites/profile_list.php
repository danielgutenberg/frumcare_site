                ...
                <div style="clear:both"></div>
				 	...
				 	<div class="row">
			            <div class="col-md-12 col-lg-3" style="margin-left:15px">
			                <a href="<?php echo site_url();?>user/unfavorite/<?php echo $data['favoritesId'];?>" class="btn btn-primary" style="font-size:13px; margin-left:5px; background-color:#5bc0de; width: 150px;" >Unfavorite</a>
			            </div>
                    </div>
			</div>
		</div>
