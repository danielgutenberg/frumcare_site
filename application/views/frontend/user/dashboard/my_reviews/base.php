        ...
        if($myreview != FALSE){ 
            ...
            <table class="table table-condensed table-striped">
      		 ...
      		 echo '<p>You have no reviews</p><br>';
      		    ...
      		    if($account_category == 1) { ?>
      		    <a href="<?php echo site_url('caregivers/review/' . get_user2(check_user())[0]['uri'] . '/' . get_user2(check_user())[0]['care_type'])?>" type="submit" class="btn btn-success" value="Sign In" style="min-width:330px; margin-left:-15px">Invite employers to write a review</a>
      		<?php }
        	?>
