...
<div class="dashboard-nav">
	<ul>
		...
		<li>
			<a href="<?php echo base_url('user/edit/'.sha1(check_user())) ?>" <?php if($this->uri->segment(2) == 'account'){?> class="active" <?php }?>>My Account</a> 
		</li>
		<li>
			<a href="<?php echo base_url();?>user/profile" <?php if(($this->uri->segment(2) == 'profile') || ($this->uri->segment(2) == 'edit_profile') || ($this->uri->segment(2) == 'addprofile') || ($this->uri->segment(2) == 'edit')){?> class="active" <?php }?> ><?php echo $profile1?></a>
		</li>
		<li>
