    ...
    <?php } ?>
     ...
     <tr>
        ...
        <td>
            ...
            <div class="details-info"><?php echo isset($pick_up_child) && $pick_up_child == 1 ? $tick : $cross?> Must be able to pick up kids from school</div>
            <div class="details-info"><?php echo isset($cook) && $cook == 1 ? $tick : $cross?> Must be able to cook/ serve meals</div>
            <div class="details-info"><?php echo isset($basic_housework) && $basic_housework == 1 ? $tick : $cross?> Must be able to do light housework/ cleaning</div>
            <div class="details-info"><?php echo isset($homework_help) && $homework_help == 1 ? $tick : $cross?> Must be able to help with homework</div>
            <div class="details-info"><?php echo isset($sick_child_care) && $sick_child_care == 1 ? $tick : $cross?> Must be able to care for sick child</div>
