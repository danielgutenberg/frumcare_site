		...
		<div class="top-bar clearfix">
                    <div class="container">
                        ...
                        <form method="get" action="<?php echo site_url();?>search">
                            <div class="search-select" style="background: url("../img/select-btns.png") no-repeat scroll 94% center #363636; ">
                            <select name="category" style="width: 100%; color: rgb(190, 186, 179); -webkit-appearance: none; -moz-appearance: none;">
